      ...
      <MakingOfTabsNav>
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-10 text-gray-800">
            <p className="mb-6">
              The Technology Adoption Barriers Survey (TABS) is more than just a questionnaire; it
              is a comprehensive research initiative supported by a robust technical ecosystem.
              Building and maintaining a platform that ensures data integrity, user privacy, and
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className="mb-4">
              ...
              Large Language Models (LLMs) to conduct exhaustive, read-only validity checks across
              our entire public-facing site.
            </p>
            <div className="mb-4">
              <Link
          ...
          <section className="mb-10 text-gray-800">
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                ...
                participants based on specific criteria - such as job seniority and industry sector
                - ensuring that our data reflects the true voice of decision-makers.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                To monitor our organic search visibility and ensure technical SEO health, we
                leverage the <strong>Google Search Console API</strong>. Daily automated workflows
                fetch impression data, keyword positioning, and click-through rates, flagging any
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                <strong>Google Tag Manager</strong> acts as the command center for our analytic
                tags. It allows us to manage and deploy marketing and measurement tags without
                modifying the code. This abstraction layer improves site performance and gives us
                the agility to add or update tracking tools as needed.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <p className="mb-4">
              Behind the scenes, TABS relies on automated workflows that connect Qualtrics,
              Prolific, and Google Analytics via GitHub Actions. These integrations handle
              everything from survey creation and participant routing to daily analytics reporting.
            </p>
            <Link
              className="inline-flex items-center rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2"
          ...
          <section className="mb-12 text-gray-800">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                >
                  <h3 className={`text-base font-semibold ${card.titleColor} mb-1`}>
                    {card.title}
                  </h3>
