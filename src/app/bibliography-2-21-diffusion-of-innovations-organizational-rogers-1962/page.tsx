      ...
      <article className={ARTICLE_CLASSES}>
        ...
        <section className={SECTION_CLASSES}>
          ...
          <p className={PARAGRAPH_CLASSES}>
            ...
            Early Majority, Late Majority, and Laggards &mdash; not only to individual
            decision-makers but to organizations as collective adopter units. This organizational
            application has distinct implications for enterprise technology adoption:
          </p>
          ...
          <p className={PARAGRAPH_CLASSES}>
            The framework also provides the theoretical basis for understanding how
            inter-organizational communication networks shape adoption. Organizations embedded in
            dense professional networks with high-quality information flows adopt earlier and with
            lower friction than isolated organizations that lack access to peer adoption knowledge.
            This network structure insight explains why technology adoption barriers are lower in
