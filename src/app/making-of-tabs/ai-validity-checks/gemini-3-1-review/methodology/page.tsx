        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <p className="mb-4">
              ...
              including <code>grep_search</code> and PowerShell&apos;s <code>Select-String</code>,
              to rapidly isolate academic citations. By searching for patterns like{' '}
            ...
            <p className="mb-4">
              ...
              knowledge base of peer-reviewed literature, industry standards, and historical
              records. The model specifically looked for:
            </p>
            <ul className="list-disc pl-6 mb-6 space-y-2">
