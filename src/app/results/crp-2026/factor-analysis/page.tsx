        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className={SECTION_CLASSES}>
            <p className={PARAGRAPH_CLASSES}>
              The {validationData.metadata.n_barriers}-item TABS Barriers scale was developed
              through a concept-mapping process that identified four theoretical sub-constructs.
              Exploratory Factor Analysis (EFA) on the CRP-200 frozen dataset (N=
              ...
              structure, with an exploratory 3-group decomposition available for
        ...
        ══════════════════════════════════════════════════════════ */}
          <section className={SECTION_CLASSES}>
            ...
            <p className={PARAGRAPH_CLASSES}>
              ...
              barriers literature. These groups were the starting hypothesis for the factor
              structure.
            </p>
        ...
        ══════════════════════════════════════════════════════════ */}
          <section className={SECTION_CLASSES}>
            ...
            <p className={PARAGRAPH_CLASSES}>
              ...
              cumulative {(validationData.Barriers.efa.total_variance * 100).toFixed(1)}% of
              variance. Factor correlations (r = .
            ...
            <p className={PARAGRAPH_CLASSES}>
              ...
              suggests that organizational leaders perceive internal barriers as a unified
              challenge, while external compliance and trust constraints form a distinct dimension.
            </p>
          </section>
        ...
        ══════════════════════════════════════════════════════════ */}
          <section className={SECTION_CLASSES}>
            ...
            <p className={PARAGRAPH_CLASSES}>
              ...
              suggesting they are best understood as facets of a single broader construct.
            </p>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6 font-sans text-sm">
              ...
              <p className="text-amber-700">
                The 3-group solution is exploratory and intended for practitioner reporting, not as
                a replacement for the statistically supported 2-factor structure. Parallel Analysis
        ...
        ══════════════════════════════════════════════════════════ */}
          <section className={SECTION_CLASSES}>
            ...
            <p className={PARAGRAPH_CLASSES}>
              ...
              infrastructure work, and External/Compliance barriers call for regulatory engagement
