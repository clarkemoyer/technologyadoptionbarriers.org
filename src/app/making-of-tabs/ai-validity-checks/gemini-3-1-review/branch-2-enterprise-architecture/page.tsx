      ...
      <MakingOfTabsNav>
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-10 text-gray-800">
            <p className="mb-6">
              This section reviews the validity of the enterprise architecture frameworks discussed
              on the site, which guide large-scale IT transformations.
            </p>
            ...
            <p className="mb-4">
              ...
              factually sound. The historical connection to the Department of Defense&apos;s TAFIM
              is also accurately noted.
            </p>
            ...
            <p className="mb-4">
              ...
              represented. The core functions of the CSF (Identify, Protect, Detect, Respond,
              Recover) are correctly listed, and the distinction between the CSF (voluntary
              guidance) and the RMF (mandatory for federal systems) is properly explained.
            </p>
