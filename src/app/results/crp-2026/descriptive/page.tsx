        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className={SECTION_CLASSES}>
            <p className={PARAGRAPH_CLASSES}>
              ...
              values are computed from the frozen CRP 2026 dataset across three sample definitions.
            </p>
          </section>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className={PARAGRAPH_CLASSES}>
              ...
              perceived by organizational leaders. Higher values indicate greater perceived
              barriers.
            </p>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className={PARAGRAPH_CLASSES}>
              The Maturity construct measures the current level of technology process maturity
              within the organization. Higher values indicate more advanced, formalized technology
              processes.
            </p>
            <div className="overflow-x-auto my-6">
              <table className="w-full border-collapse font-sans text-sm">
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className={PARAGRAPH_CLASSES}>
              ...
              means, computed independently on each of the three CRP sample groups. Negative
            ...
            {/* One correlation matrix per CRP sample group */}
            {[
            ...
            <p className="text-sm text-gray-500">
              ...
              page for dataset methodology and sample definitions.
            </p>
          </section>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-6">
              <p className="text-sm text-amber-900">
                ...
                response option. These responses are excluded from scoring &mdash; they are treated
                as missing data rather than mapped to a numeric value. This prevents artificial
                deflation of construct means. The Barriers construct does not offer a
                &ldquo;Don&rsquo;t Know&rdquo; option.
              </p>
            </div>
          </section>
...
export default CrpDescriptivePage
