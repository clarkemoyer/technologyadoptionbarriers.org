...
def main():
    ...
    summary = {
        ...
        "study": {
            ...
            "totalAvailablePlaces": study.get("total_available_places", 0),
            "placesTaken": study.get("places_taken", 0),
            "averageRewardPerHour": study.get("average_reward_per_hour", 0),
            "averageTimeTaken": study.get("average_time_taken", 0),
