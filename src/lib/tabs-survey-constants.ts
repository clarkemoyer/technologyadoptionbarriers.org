...
export const MATURITY_ITEM_NAMES_NOTE =
  'MATURITY_ITEM_NAMES contains the canonical survey item names as they appear in the Qualtrics CSV column subheaders. ' +
  'MATURITY_SUBCONSTRUCT_GROUPINGS uses the same canonical names in its item field so entries can be joined deterministically to MATURITY_ITEM_NAMES, ' +
  'while itemCode stores the survey dimension identifier (D1-D8). ' +
  'The grouping labels synthesize related capability domains across CMMI v2.0, IT-CMF, COBIT 2019, and DREAMY into unified conceptual categories. ' +
  'For items D1-D5, the canonical names and grouping labels are closely aligned. ' +
  "For D6-D8, the grouping labels are broader (e.g., 'Strategy & Architecture' encompasses both strategic planning and enterprise architecture maturity)."
