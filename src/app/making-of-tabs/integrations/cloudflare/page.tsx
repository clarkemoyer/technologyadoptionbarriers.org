      ...
      <MakingOfTabsNav>
       ...
       → GitHub Pages origin (static files)`}
            ...
            <p className="mb-4">
              ...
              are no Cloudflare Workers, no <code>wrangler.toml</code>, no edge functions.
              Cloudflare is a purely infrastructure-level integration configured entirely through
          ...
          <section className="mb-10 text-gray-800">
            ...
            <p className="mb-4">
              ...
              <code>public/CNAME</code> file in the repository tells GitHub Pages which custom
              domain to serve.
            </p>
          </section>
              ...
              <table className="min-w-full border border-gray-200 text-sm font-sans">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="px-4 py-2 border-b">
                      <strong>Full (strict)</strong> - end-to-end encryption, GitHub Pages
          ...
          <section className="mb-10 text-gray-800">
            ...
            <p className="mb-4">
              Several Cloudflare features are enabled to improve page load times, all available on
              the Free plan:
            </p>
            <div className="overflow-x-auto mb-4">
              <table className="min-w-full border border-gray-200 text-sm font-sans">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-2">
                      Zero round-trip reconnection for returning visitors
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <p className="mb-4">
              Cloudflare Transform Rules inject security headers on every response. These headers
              are configured in the Cloudflare dashboard (not in the application code) and apply
          ...
          <section className="mb-10 text-gray-800">
            ...
            <p className="mb-4">
              Cloudflare&rsquo;s proxy provides built-in DDoS mitigation at no cost. Because the
              TABS site is a statically exported Next.js application, the attack surface is
              inherently small:
            </p>
            <ul className="list-disc pl-5 space-y-2 mb-6 font-sans text-base">
              <li>
                <strong>No server-side logic</strong> - there are no API routes, no database
                queries, and no dynamic rendering to overwhelm
              </li>
              <li>
                <strong>High cacheability</strong> - most requests are served from
                Cloudflare&rsquo;s edge cache without reaching the origin
              </li>
              <li>
            ...
            <p className="mb-4">
              A Web Application Firewall (WAF) evaluation is on the long-term security roadmap. For
              a static site, the Free plan&rsquo;s managed rules and DDoS protection provide a
              strong baseline.
            </p>
          </section>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <ul className="list-disc pl-5 space-y-2 mb-6 font-sans text-base">
              ...
              <li>
                <strong>Cloudflare Analytics</strong> - analytics are handled by Google Analytics
                and Microsoft Clarity, which provide richer behavioral data
              </li>
              <li>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <ul className="list-disc pl-5 space-y-3 mb-6 font-sans text-base">
              <li>
                ...
                Transform Rules, unlimited bandwidth, and global CDN - the Free tier covers
                everything a static nonprofit site needs.
              </li>
              <li>
              ...
              <li>
                <strong>Security headers belong at the edge.</strong> Injecting headers via
                Cloudflare Transform Rules means they apply to every response - including error
                pages and redirects - without relying on application-level middleware that a static
