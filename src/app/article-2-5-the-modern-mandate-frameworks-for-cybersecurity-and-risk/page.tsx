    ...
    <main className="pt-20 sm:pt-[120px] min-h-screen bg-white">
      <article className={ARTICLE_CLASSES}>
        <h1 className={H1_CLASSES}>
          Article 2.5: The Modern Mandate &ndash; Frameworks for Cybersecurity and Risk
        </h1>
        ...
        <section className={SECTION_CLASSES}>
          <p className={PARAGRAPH_CLASSES}>
            ...
            technology&ndash;firewalls, intrusion detection systems, antivirus software&ndash;yet
            the breach still occurred. The problem was not lack of technology; it was lack of
            systematic security practice. The organization had security tools but no coherent
            security framework, no systematic monitoring approach, no clear understanding of
          ...
          <p className={PARAGRAPH_CLASSES}>
            ...
            struggle with asset visibility&ndash;they do not have complete inventories of systems,
          ...
          <p className={PARAGRAPH_CLASSES}>
            ...
            Industrial Base&ndash;companies that supply products and services to the Department of
          ...
          <p className={PARAGRAPH_CLASSES}>
            <strong>Levels 3&ndash;5 (Progressive) </strong>require progressively more sophisticated
          ...
          <p className={PARAGRAPH_CLASSES}>
            ...
            they are complementary rather than competitive&ndash;they address the same security
          ...
          <p className={PARAGRAPH_CLASSES}>
            ...
            complementary approaches&ndash;technical controls, procedural controls, and
            organizational practices all matter. Third, they recognize that security is not static;
            it requires continuous improvement and adaptation as threats evolve.
          </p>
          <p className={PARAGRAPH_CLASSES}>
            These frameworks are not in competition. The NIST RMF and CSF are
            complementary&ndash;the RMF provides detailed technical guidance while the CSF provides
            a high-level functional framework. CMMC builds on NIST standards by adding third-party
            certification. ISO 27001 provides international applicability. Organizations often
            implement multiple frameworks simultaneously, recognizing that each provides value.
          </p>
          <p className={PARAGRAPH_CLASSES}>
            ...
            as baselines&ndash;minimum expectations&ndash;and going beyond compliance to build
          ...
          <p className={PARAGRAPH_CLASSES}>
            ...
            it. The goal is not perfect security&ndash;an impossible and economically unjustifiable
          ...
          <p className={PARAGRAPH_CLASSES}>
            ...
            consequences, this framework-driven approach to security management is not
            optional&ndash;it is essential.
          </p>
        </section>
        ...
        <section className="pt-8 border-t border-gray-200">
          ...
          <ol className={REFERENCES_OL_CLASSES}>
            ...
            <li>
              ISO/IEC. (2022). ISO/IEC 27001:2022 &ndash; Information Security Management Systems.
