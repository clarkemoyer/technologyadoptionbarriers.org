...
| `find_stale_return_requested.py`  | Classify AWAITING REVIEW into stale-action buckets (stale*no_reply_to_rr, stale_no_reply_to_message, in_window*\*) | Pipeline Phase 3c (after dashboard); shared `_fetch_messages_with_backoff` helper |
