...
const ResultCard: React.FC<ResultCardProps> = ({ title, description }) => {
  ...
  return (
    <div className="w-full h-[300px] px-[20px] flex items-center justify-center flex-col border-[5px] border-tabs-orange rounded-[20px] shadow-[0px_16px_16px_0px_#11253E0F]">
