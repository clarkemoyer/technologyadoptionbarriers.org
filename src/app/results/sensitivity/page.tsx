        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className={SECTION_CLASSES}>
            <p className={PARAGRAPH_CLASSES}>
              ...
              five nested sample definitions. If a finding holds across Conservative Clean (N=
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className={PARAGRAPH_CLASSES}>
              ...
              from most restrictive to least restrictive, with the exception of Prolific Accepted
              and All V2 Finished, which overlap but neither is a strict subset of the other.
            </p>
                    ...
                    {metrics.map((metric, i) => (
                      <tr key={metric.key} className={i % 2 === 1 ? 'bg-gray-50' : ''}>
                        ...
                        {samples.map((s) => (
                          ...
                          >
                            {fmt(
                              (metric.values as Record<string, number | null>)[s.key] ?? null,
                              4
                            )}
                          </td>
                        ))}
          ...
          <section className="mb-12 text-gray-800">
            ...
            <ul className="list-disc pl-5 space-y-2 mb-6 font-sans text-base">
              <li>
                <strong>Construct means</strong> are highly stable, with differences of less than
                0.10 scale points between the most and least restrictive samples.
              </li>
              <li>
                <strong>Standard deviations</strong> increase slightly with less restrictive
                samples, as expected when including noisier data.
              </li>
              <li>
                <strong>Correlations</strong> between constructs are directionally consistent across
                all samples (Barriers negatively correlated with Readiness and Maturity; Readiness
                and Maturity positively correlated).
              </li>
              <li>
                <strong>Cronbach&rsquo;s alpha</strong> values remain excellent (&gt; 0.84) across
                all samples, indicating robust internal consistency regardless of inclusion
                criteria.
              </li>
            </ul>
            <p className={PARAGRAPH_CLASSES}>
