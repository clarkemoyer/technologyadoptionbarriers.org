        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className={SECTION_CLASSES}>
            ...
            <p className={PARAGRAPH_CLASSES}>
              ...
              Cronbach&rsquo;s alpha exceeding 0.84 across all five sample definitions. This
              indicates that the survey items within each construct are measuring the same
              underlying factor reliably, regardless of which inclusion criteria are applied.
            </p>
          </section>
