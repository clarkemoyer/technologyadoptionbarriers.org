      ...
      <MakingOfTabsNav>
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className="mb-6">
              Each integration has a dedicated page with detailed methodology, architecture
          ...
          <section className="mb-12 text-gray-800">
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                Every Qualtrics API call is authenticated with an <code>X-API-TOKEN</code> header.
                The token is stored as a GitHub Actions secret in the <code>qualtrics-prod</code>{' '}
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className="mb-4">
              ...
              participants by job seniority, industry sector, and other criteria - ensuring the
              survey reaches the right audience. The TABS integration uses Prolific&apos;s REST API
              v1 for automated weekly data collection.
            </p>

            <div className="mb-8">
              <h3 className={H3_CLASSES}>How Prolific Connects to Qualtrics</h3>
              <p className="mb-4">
                When a Prolific participant starts the study, Prolific opens the Qualtrics survey
                URL and appends three URL parameters: <code>PROLIFIC_PID</code>,{' '}
                <code>STUDY_ID</code>, and <code>SESSION_ID</code>. Qualtrics captures these as
                Embedded Data fields, which allows us to link each survey response back to the
                Prolific submission.
              </p>
              <p className="mb-4">
                At the end of the survey, the respondent is redirected to the appropriate
                destination based on the Survey Flow logic. Prolific participants are redirected to
                Prolific&apos;s completion page (with a completion code), while website visitors see
                a thank-you page on the TABS site.
              </p>
            </div>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                Without the lockdown, the redirect URL (<code>COMPLETE_URL</code>) could be passed
                as a URL parameter by anyone, creating an open-redirect vulnerability. The
                two-branch design hard-codes <code>COMPLETE_URL</code> inside the Survey Flow so
                that inbound URLs cannot override it.
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="mb-6 rounded-lg border border-blue-200 bg-blue-50 p-4">
                ...
                <p className="text-sm text-blue-800">
                  When the <code>SOURCE</code> field has any value (e.g., <code>TABS_Website</code>{' '}
                  or <code>prolific</code>), the respondent came from a known channel. This branch
                  sets <code>COMPLETE_URL</code> to the <strong>website completion page</strong> and
                  ends the survey with a redirect.
                </p>
              </div>
              ...
              <div className="mb-6 rounded-lg border border-green-200 bg-green-50 p-4">
                ...
                <p className="text-sm text-green-800">
                  ...
                  <code>SOURCE</code> being set (e.g., due to a misconfigured study URL), the
                  presence of <code>PROLIFIC_PID</code> alone is enough to tag them. This branch
                  sets <code>SOURCE=&quot;prolific&quot;</code>, sets <code>COMPLETE_URL</code> to
                  the <strong>Prolific completion URL</strong>, and ends the survey with a redirect
                  to Prolific.
                </p>
              </div>
              ...
              <p className="text-sm text-gray-600 italic">
                ...
                them to the website completion page. This is intentional - the website thank-you
                page is appropriate for all respondents, and Prolific tracks completion
                independently via its authenticity script.
              </p>
            </div>
...
└─────────────────────────────────────────────┘`}</pre>
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                A read-only workflow (<code>qualtrics-dump-flow.yml</code>) exports the current
                Survey Flow JSON. The output is printed to the workflow log and uploaded as a
                downloadable artifact. This is useful for verifying that the apply script produced
                the expected result, or for debugging API issues.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <ul className="mb-4 list-disc space-y-2 pl-6">
              <li>
                ...
                architecture, verification, and annual rollover (
                <code>PROLIFIC_INTEGRATION.md</code>)
              </li>
              <li>
              ...
              <li>
                <strong>MCP Servers</strong> - Model Context Protocol integration for AI coding
                agents (<code>MCP_SERVERS.md</code>)
              </li>
            </ul>

            <p className="text-sm text-gray-600">
              All documentation is in the repository root. The source code for client libraries
              lives in <code>src/lib/</code>, and workflow files are in{' '}
