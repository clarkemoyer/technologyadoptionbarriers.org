        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <p className="mb-4">
              ...
              view, but it cannot show <em>how</em> they interact with those pages. Microsoft
              Clarity fills this gap with two features that are otherwise expensive or absent:
            </p>
                ...
                <table className="min-w-full border border-gray-200 text-sm font-sans">
                  ...
                  <tbody>
                    ...
                    <tr className="bg-gray-50">
                      ...
                      <td className="px-4 py-2 border-b">
                        An inline <code>&lt;script&gt;</code> is appended to{' '}
                        <code>&lt;head&gt;</code> that bootstraps the Clarity SDK using the project
                        ID from <code>NEXT_PUBLIC_CLARITY_PROJECT_ID</code>
                      </td>
                    </tr>
                    <tr>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <p className="mb-4">
              ...
              after the initial load — navigating between pages uses client-side routing, which
              means Clarity would record every page view as the landing page URL. To solve this, a
              dedicated <code>ClarityRouteTracker</code> component is rendered in the root layout.
            </p>
            ...
            <div className="mb-8">
              ...
              <ul className="list-disc pl-5 space-y-2 mb-6 font-sans text-base">
                ...
                <li>
                  ...
                  <code>window.clarity(&apos;set&apos;, &apos;page&apos;, path)</code> to tell
                  Clarity which page the visitor is now viewing.
                </li>
                <li>
                  It prepends <code>NEXT_PUBLIC_BASE_PATH</code> to the pathname so the paths
                  recorded in Clarity match the deployed URLs (important for GitHub Pages, which
                  uses a repository-name prefix).
                </li>
                <li>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <ul className="list-disc pl-5 space-y-2 mb-6 font-sans text-base">
              ...
              <li>
                ...
                <code>
                  window.clarity(&apos;set&apos;, &apos;page&apos;, &apos;/some-path&apos;)
                </code>{' '}
                is invoked with the current pathname
              </li>
              <li>
                <strong>Base path handling</strong> — when <code>NEXT_PUBLIC_BASE_PATH</code> is
                set, the path is prefixed correctly
              </li>
              <li>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <ul className="list-disc pl-5 space-y-3 mb-6 font-sans text-base">
              <li>
                ...
                <code>ClarityRouteTracker</code>, every session shows the landing page for every
                page view. This is easy to miss because the behavior only becomes obvious after
                analyzing real sessions in the Clarity dashboard.
              </li>
              <li>
                <strong>GTM is not always the right loader.</strong> Loading Clarity through GTM
                would add complexity (container tag configuration, consent mode mapping) without
                benefit. A single <code>createElement(&apos;script&apos;)</code> call with dynamic
                consent gating is simpler and more transparent.
              </li>
              <li>
                <strong>Cookie cleanup matters.</strong> Deleting <code>_clck</code> and{' '}
                <code>_clsk</code> when consent is withdrawn demonstrates genuine GDPR respect
                rather than merely stopping the script.
              </li>
              <li>
                <strong>Free tier, no compromises.</strong> Clarity has no traffic limits, no
                feature restrictions, and no paid upgrade required. For a nonprofit research
                project, this is invaluable.
              </li>
            </ul>
          </section>
