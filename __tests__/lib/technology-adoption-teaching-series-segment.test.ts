...
describe('technology-adoption-teaching-series-segment', () => {
  ...
  describe('buildTeachingSeriesSlideSegment', () => {
    ...
    it('handles titles with special characters gracefully', () => {
      ...
      // É decomposes under NFKD and its combining mark is stripped → 'e'.
      // ø (U+00F8) does NOT decompose under NFKD and is outside the combining-marks
      // range (U+0300–U+036F), so it is replaced by '-' as a non-alphanumeric character.
