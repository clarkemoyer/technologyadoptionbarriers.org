...
export const DispositionSummarySchema = z
  .object({
    ...
    autoExcludeBreakdown: z.record(z.string(), z.number().int().nonnegative()),
    dispositionByStatus: z.record(z.string(), z.record(z.string(), z.number().int().nonnegative())),
    study: z
      .object({
        id: z.string().min(1),
        name: z.string().min(1),
    ...
    actions: z
      .object({
        ...
        messaged: z.number().int().nonnegative(),
      })
      .strict(),
    iriPassRates: z
      .object({
