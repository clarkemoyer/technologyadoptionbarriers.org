  ...
  return (
    <main className={`${ARTICLE_CLASSES} pt-28 sm:pt-32`}>
      ...
      <p className="mb-8 text-lg sm:text-xl text-gray-600 font-sans">
        Consent-gated behavioral analytics with heatmaps, session recordings, and SPA route tracking
      ...
      <section className="mb-10 text-gray-800">
        ...
        <ul className="list-disc pl-5 space-y-2 mb-6 font-sans text-base">
          <li>
            <strong>Heatmaps</strong> — aggregated click, scroll, and movement maps for every page,
        ...
        <p className="mb-4">
          Clarity is completely free with no traffic caps, making it ideal for a nonprofit project.
          It runs alongside Google Analytics without conflict, each serving a distinct purpose:
          quantitative metrics (GA4) versus qualitative behavior (Clarity).
        </p>
      </section>
      ...
      <section className="mb-10 text-gray-800">
        ...
        <p className="mb-4">
          Clarity is <strong>not</strong> loaded via Google Tag Manager. Instead, the cookie consent
          component dynamically injects the Clarity tracking script into <code>&lt;head&gt;</code>{' '}
          only after the visitor explicitly accepts <strong>Analytics</strong> cookies. This design
          ensures GDPR compliance by default.
        </p>
        ...
        <div className="mb-8">
          ...
          <p className="mb-4">
            ...
            Clarity&rsquo;s first-party cookies (<code>_clck</code> and <code>_clsk</code>) and the
            script is not reloaded until consent is granted again.
          </p>
        </div>
      ...
      <section className="mb-10 text-gray-800">
        ...
        <p className="mb-4">
          ...
          the initial load — navigating between pages uses client-side routing, which means Clarity
          would record every page view as the landing page URL. To solve this, a dedicated{' '}
        ...
        <div className="mb-8">
          ...
          <p className="mb-4">
            <code>ClarityRouteTracker</code> renders <strong>before</strong> the main content in the
            root layout, ensuring it intercepts every navigation regardless of how deeply a
  ...
  <CookieConsent />          ← injects Clarity script
      ...
      <section className="mb-10 text-gray-800">
        ...
        <ul className="list-disc pl-5 space-y-2 mb-6 font-sans text-base">
          ...
          <li>
            <strong>Route updates</strong> — re-rendering with a new pathname triggers a new Clarity
            call
          </li>
          <li>
