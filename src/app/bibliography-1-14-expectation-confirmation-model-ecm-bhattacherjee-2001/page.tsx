            ...
            <ul className={BODY_LIST_CLASSES}>
              <li>
                ...
                <ul className="list-disc pl-6 mt-2 space-y-1">
                  <li>
                    Extended ECM models incorporating additional variables (such as switching costs,
                    habit, social influences)
                  </li>
                  <li>
                    Models examining continuance across diverse information systems (social media,
                    productivity software, enterprise systems)
                  </li>
                  <li>Technology Abandonment models</li>
                  <li>Digital Engagement and Sustained Use models</li>
                </ul>
                <em>Following Theories:</em>
                <ul className="list-disc pl-6 mt-2 space-y-1">
                  <li>Research on information systems habit and behavioral inertia</li>
                  <li>Studies of customer loyalty in digital contexts</li>
                  <li>Discontinuance and switching behavior research</li>
                  <li>Service continuance models in electronic commerce</li>
                </ul>
              </li>
            </ul>
          </section>
          ...
          <section className={SECTION_CLASSES}>
            ...
            <ol className="list-decimal list-inside space-y-3 text-sm">
              ...
              <li>
                ...
                Expectation-Confirmation Model.&quot; <em>MIS Quarterly</em> 25, no. 3 (2001):
                351-370.
              </li>
              <li>
              ...
              <li>
                ...
                Perceptions in Information Technology Adoption.&quot;{' '}
                <em>Decision Support Systems</em> 22, no. 1 (1998): 15-29.
              </li>
              <li>
                ...
                Beliefs.&quot; <em>MIS Quarterly</em> 23, no. 2 (1999): 183-213.
              </li>
            </ol>
          </section>
