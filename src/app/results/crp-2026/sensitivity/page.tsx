      ...
      <ResultsNav>
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className={PARAGRAPH_CLASSES}>
              The three primary result groups below are used throughout this analysis. They are
              nested from most restrictive to least restrictive.
            </p>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className={PARAGRAPH_CLASSES}>
              The table below shows every metric computed across all three sample definitions.
              Values are formatted to four decimal places. Means, standard deviations, correlations,
              and Cronbach&rsquo;s alpha coefficients are all included.
            </p>
