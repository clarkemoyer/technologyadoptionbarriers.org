...
const CloudflareIntegrationPage = () => {
  return (
    <main className={`${ARTICLE_CLASSES} pt-28 sm:pt-32`}>
      {/* Breadcrumb */}
      <nav className="mb-6 text-sm font-sans text-gray-500" aria-label="Breadcrumb">
        <ol className="flex flex-wrap items-center gap-1">
          ...
          <li className="text-gray-700 font-medium">Cloudflare</li>
        </ol>
      </nav>
      ...
      <section className="mb-10 text-gray-800">
        ...
        <p className="mb-4">
          ...
          <code>technologyadoptionbarriers.org</code> flows through Cloudflare&rsquo;s edge network
       ...
       → GitHub Pages origin (static files)`}
        ...
        <p className="mb-4">
          The Next.js application itself has <strong>no awareness of Cloudflare</strong>. There are
          no Cloudflare Workers, no <code>wrangler.toml</code>, no edge functions. Cloudflare is a
          purely infrastructure-level integration configured entirely through the Cloudflare
          dashboard.
        </p>
      </section>
      ...
      <section className="mb-10 text-gray-800">
        ...
        <p className="mb-4">
          ...
          <strong>Proxy status = Proxied</strong> (orange cloud), meaning traffic is routed through
          Cloudflare&rsquo;s network rather than directly to GitHub:
        </p>
        ...
        <p className="mb-4">
          ...
          <code>public/CNAME</code> file in the repository tells GitHub Pages which custom domain to
          serve.
        </p>
      </section>
          ...
          <table className="min-w-full border border-gray-200 text-sm font-sans">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="px-4 py-2 border-b">Enabled — HTTP requests redirected to HTTPS</td>
              </tr>
              <tr className="bg-gray-50">
      ...
      <section className="mb-10 text-gray-800">
        ...
        <p className="mb-4">
          ...
          site is a statically exported Next.js application, the attack surface is inherently small:
        </p>
      ...
      <section className="mb-10 text-gray-800">
        ...
        <ul className="list-disc pl-5 space-y-2 mb-6 font-sans text-base">
          <li>
            <strong>Cloudflare Workers / Pages</strong> — the site is deployed via GitHub Pages, not
            Cloudflare Pages. Cloudflare Pages is recommended as a future option for PR preview
            deployments.
          </li>
          <li>
      ...
      <section className="mb-10 text-gray-800">
        ...
        <ul className="list-disc pl-5 space-y-3 mb-6 font-sans text-base">
          <li>
            ...
            Transform Rules, unlimited bandwidth, and global CDN — the Free tier covers everything a
            static nonprofit site needs.
          </li>
          <li>
            ...
            GitHub Pages unverified. &quot;Full (strict)&quot; validates the origin certificate and
            provides genuine end-to-end encryption.
          </li>
          <li>
            <strong>Tiered caching avoids stale pages.</strong> Giving HTML files a 1-hour TTL means
            deployments propagate quickly, while hashed static assets can be cached aggressively
            without ever serving stale content.
          </li>
          <li>
            <strong>Security headers belong at the edge.</strong> Injecting headers via Cloudflare
            Transform Rules means they apply to every response — including error pages and redirects
            — without relying on application-level middleware that a static export cannot provide.
          </li>
        </ul>
      </section>
