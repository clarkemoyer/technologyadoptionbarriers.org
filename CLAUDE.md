...
- **User ID**: Set via `ZOTERO_USER_ID` environment variable (your Zotero account user ID)
...
- **User ID**: Set `ZOTERO_USER_ID` to your Zotero account user ID (for example, `export ZOTERO_USER_ID="<your-zotero-user-id>"`)
