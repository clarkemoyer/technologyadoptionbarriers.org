...
- **Qualtrics/SAP:** We already use the first-party Qualtrics platform MCP endpoint (`/API/mcp/survey-crud`). We monitor official SAP/Qualtrics channels for expanded support: GA availability, stable versioning, and comprehensive docs. SAP is a member of the [AI Alliance](https://theaialliance.ai/).
