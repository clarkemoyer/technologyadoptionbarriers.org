        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className={SECTION_CLASSES}>
            <p className={PARAGRAPH_CLASSES}>
              ...
              the quality checks applied at each stage, the edge cases we discovered and resolved,
              and the sensitivity analysis that demonstrates our findings are robust to inclusion
              criteria.
            </p>
            <p className={PARAGRAPH_CLASSES}>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <ol className={BODY_OL_CLASSES}>
              ...
              <li>
                ...
                Prolific submission data (approval status, auth check scores) using the participant
                ID as join key
              </li>
              <li>
                <strong>Deduplication</strong> &mdash; When a participant retakes the survey, only
                one response is kept. Completed responses are preferred over incomplete retakes (see
                Edge Cases below)
              </li>
              <li>
              ...
              <li>
                <strong>Sample Definition</strong> &mdash; Five nested samples are computed, from
          ...
          <section className="mb-12 text-gray-800">
              ...
              <table className="w-full border-collapse font-sans text-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 px-4 py-2">
                      ✅ Available via API for cross-validation and sample balancing; base fields
                      not published on results pages (privacy protection)
                    </td>
                  </tr>
                  <tr className="bg-gray-50">
                    <td className="border border-gray-300 px-4 py-2 font-semibold">
                    ...
                    <td className="border border-gray-300 px-4 py-2" colSpan={2}>
                      ...
                      Qualtrics{' '}
                      <code className="bg-gray-100 px-1 rounded text-xs">Q3_Industry</code>,
                      Prolific{' '}
                      <code className="bg-gray-100 px-1 rounded text-xs">company_size</code> &harr;
                      Qualtrics <code className="bg-gray-100 px-1 rounded text-xs">Q4_OrgSize</code>
                      , Prolific{' '}
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
              <p className="text-sm text-amber-900">
                ...
                cross-validation opportunity to verify self-reported data and balance samples. The
                two are joined via Prolific Participant ID (PID).
              </p>
            </div>
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mt-4">
              ...
              <ul className="text-xs text-red-700 space-y-1 list-disc list-inside mb-2">
                ...
                <li>
                  Published results pages display only category-level aggregates from Qualtrics
                  survey data (Q1&ndash;Q9), never individual Prolific profile data
                </li>
                <li>
                  ...
                  <code className="bg-red-100 px-1 rounded">prolific-api.ts</code> documents the
                  exact eligibility criteria and filter_ids used for enrichment export
                </li>
              </ul>
                ...
                <table className="w-full text-xs border-collapse mb-2">
                  <thead>
                    <tr className="bg-red-100">
                      ...
                      <th className="border border-red-200 px-2 py-1 text-right font-bold">
                        Count
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr className="bg-red-100/50 font-bold">
                      ...
                      <td className="border border-red-200 px-2 py-1 text-right font-mono">
                        7 / 15
                      </td>
                    </tr>
                  </tbody>
                ...
                <tbody>
                  {[
                    ...
                    [
                      '1',
                      'FLAG-AUTH-FAIL',
                      'Prolific authenticity check: LLM or Bots score = "Low"',
                    ],
                    [
                      '2',
                      'FLAG-AUTH-MIXED',
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className="text-sm text-gray-500">
              ...
              All V2, and All V2 Finished &sube; All V2. Prolific Accepted and All V2 Finished
              overlap but neither is guaranteed to be a subset of the other (Prolific Accepted
              includes INCOMPLETE+APPROVED responses; All V2 Finished includes non-APPROVED
              responses).
            </p>
          </section>
            ...
            <div className="space-y-6 my-6">
              ...
              <div className="border border-gray-200 bg-gray-50 rounded-lg p-5">
                ...
                <p className="text-sm text-gray-700 mb-3">
                  ...
                  Prolific status &mdash; includes returned, timed-out, and awaiting-review
                  participants.
                </p>
            ...
            <div className="bg-white border-2 border-amber-400 rounded-lg p-5 my-6">
              ...
              <ul className="text-sm text-gray-800 space-y-2 list-disc list-inside ml-2">
                <li>
                  ...
                  <strong>operations pipeline</strong> to auto-approve participants on Prolific.
                  Does <em>not</em> check Prolific_Status.
                </li>
                <li>
              ...
              <p className="text-sm text-gray-700 mt-3">
                ...
                all Disposition CLEAN participants should have Prolific_Status == APPROVED, making
                the counts equal. Any persistent gap indicates a pipeline issue. The disposition
                dashboard cross-references these counts automatically.
              </p>
            </div>
          </section>
            ...
            <div className="space-y-8 my-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <p className={PARAGRAPH_CLASSES}>
                  ...
                  regardless of chronological order. This ensures the approved, completed response
                  is used for analysis rather than being overwritten by an abandoned retake.
                </p>
                <p className="text-sm text-gray-500 mt-2">
                  Note: The TypeScript disposition triage (used by the operations pipeline) still
                  uses &ldquo;latest row wins&rdquo; dedup, which can keep an incomplete retake over
                  a completed original. This is being addressed in issue #687 (TS → Python
                  migration). The Python analysis pipeline already applies the correct logic.
                </p>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <p className={PARAGRAPH_CLASSES}>
                  ...
                  within-person standard deviation per question block. If a respondent selected
                  nearly identical answers for all items in a block (SD &lt; 0.5), the response is
                  flagged. The threshold follows Meade &amp; Craig (2012),{' '}
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                <h3 className={H3_CLASSES}>
                  Don&rsquo;t Know Responses (Readiness &amp; Maturity)
                </h3>
                <p className={PARAGRAPH_CLASSES}>
                  ...
                  construct scores. The Barriers construct does not include a Don&rsquo;t Know
                  option.
                </p>
              </div>
            </div>
