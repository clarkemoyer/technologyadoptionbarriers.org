        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <p className="mb-4">
              ...
              review confirmed that the site accurately lists the four core determinants of
              intention and usage: Performance Expectancy, Effort Expectancy, Social Influence, and
              Facilitating Conditions. The moderating variables (Gender, Age, Experience,
              Voluntariness of Use) are also correctly identified.
            </p>
            ...
            <p className="mb-4">
              The extension of UTAUT to consumer contexts (Venkatesh, Thong, & Xu, 2012) was
              verified. The addition of Hedonic Motivation, Price Value, and Habit as new constructs
              is factually accurate and aligns with the original 2012 publication.
            </p>
