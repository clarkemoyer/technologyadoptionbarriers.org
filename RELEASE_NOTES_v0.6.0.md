...
**168 substantive merged PRs (plus 53 routine daily pipeline / GA-stats PRs), 66 substantive closed issues (out of 99 total; excludes routine `Daily Disposition Report`, `Broken links detected`, and `Production smoke test failed` auto-issues), 99 commits since v0.5.0.**
