      ...
      <MakingOfTabsNav>
        <article className={ARTICLE_CLASSES}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="rounded-xl border border-blue-200 bg-blue-50 p-6">
                ...
                <p className="text-sm text-blue-800 mb-3">
                  Serves dual roles: inline code completion during editing, and automated pull
                  request reviewer. Every PR gets a Copilot code review that catches issues ranging
                  from unused variables to accessibility problems. We typically require 3 clean
              ...
              <div className="rounded-xl border border-green-200 bg-green-50 p-6">
                ...
                <p className="text-sm text-green-800 mb-3">
                  Used for brainstorming, content drafting, and reasoning about complex
                  architectural decisions. The o1 reasoning model is particularly useful for
                  thinking through multi-step problems where the solution path is not obvious.
                </p>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p>
                    ...
                    feedback, makes fixes, pushes again, and requests another review. Once reviews
                    are clean and CI is green, the human approves the merge.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className="mb-6">
              AI agents are only as good as the context they receive. We maintain several
              instruction files that teach agents about our project conventions, architecture, and
              workflows:
            </p>
            ...
            <p className="mb-4">
              ...
              read documentation. They are version-controlled alongside the code and updated
              whenever the project&apos;s conventions change. This creates a virtuous cycle: better
              instruction files produce better AI output, which reveals what the instruction files
              are missing.
            </p>
          </section>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="rounded-xl border border-gray-200 p-6">
                ...
                <p className="text-sm text-gray-700 mb-3">
                  ...
                  surveys, inspect definitions, and manage survey operations — useful for the annual
                  survey rollover process.
                </p>
              </div>
            </div>
            ...
            <p>
              ...
              it, open a PR, and request a review&quot; in a single conversation. This is how most
              of our development actually happens.
            </p>
          </section>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <ul className="list-disc pl-6 space-y-3 mb-6">
              ...
              <li>
                <strong>jest-axe accessibility</strong> — automated WCAG compliance checks that
                catch missing ARIA labels, incorrect roles, and color contrast issues
              </li>
              <li>
              ...
              <li>
                <strong>Lighthouse CI</strong> — performance, accessibility, and SEO scoring on
                every merge to main
              </li>
            </ul>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <div className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <li>
                  <strong>Accessibility fixes</strong> — identifying and fixing ARIA issues,
                  semantic HTML problems, and keyboard navigation gaps
                </li>
                <li>
            ...
            <div className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <li>
                  <strong>Cross-session context</strong> — agents lose context between
                  conversations; the instruction files partially solve this, but complex multi-day
                  work requires human continuity
                </li>
                <li>
                ...
                <li>
                  <strong>Knowing when to stop</strong> — agents sometimes over-engineer solutions
                  or make unnecessary &quot;improvements&quot; that the human did not request
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className="mb-6">
              The key insight is not that AI writes perfect code. It does not. The key insight is
              that with good guardrails — CI, automated review, accessibility checks — the imperfect
              code gets caught and fixed before it matters. The velocity gain comes from the AI
              handling the mechanical work while the human focuses on direction and quality
              judgment.
            </p>
          </section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="text-sm text-red-800">
                  A single squash merge silently reverted 25+ PRs across 67 files. How speed
                  amplifies mistakes, and the safeguards we built afterward.
                </p>
              </Link>
            </div>
          </section>
