...
BOOTSTRAP /SAMPLING METHOD=SIMPLE /VARIABLES TARGET=B1 TO B18 INPUT=
  /CRITERIA CILEVEL=95 CITYPE=PERCENTILE NSAMPLES=2000 /MISSING USERMISSING=EXCLUDE.
...
BOOTSTRAP /SAMPLING METHOD=SIMPLE /VARIABLES TARGET=R1 TO R17 INPUT=
  /CRITERIA CILEVEL=95 CITYPE=PERCENTILE NSAMPLES=2000 /MISSING USERMISSING=EXCLUDE.
...
BOOTSTRAP /SAMPLING METHOD=SIMPLE /VARIABLES TARGET=M1 TO M8 INPUT=
  /CRITERIA CILEVEL=95 CITYPE=PERCENTILE NSAMPLES=2000 /MISSING USERMISSING=EXCLUDE.
