                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-4">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        {typeof effects['tech_vs_nontech'].tech_n === 'number' &&
                        typeof effects['tech_vs_nontech'].nontech_n === 'number' ? (
                          <EffectSizeChart
                          ...
                          <p className="text-xs text-gray-500 italic mb-4">
                            Chart unavailable: missing sample size.
                          </p>
                        )}
                      ...
                      Object.keys(effects['large_vs_small'].constructs ?? {}).length > 0 && (
                        <div className="space-y-4">
                          <div>
                            ...
                            {typeof effects['large_vs_small'].large_n === 'number' &&
                            typeof effects['large_vs_small'].small_medium_n === 'number' ? (
                              <EffectSizeChart
