        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                ...
                allowing us to manage tracking without modifying application code. The GA4
                measurement ID is configured inside the GTM container, not hardcoded in the site
                source.
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                This approach respects visitor privacy while providing aggregate, anonymized
                insights for measuring research impact.
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                ...
                . A service account authenticates with a private key stored as a GitHub Actions
                secret in the <code>google-prod</code> environment. The service account has
                read-only access to the GA4 property - it cannot modify tracking configuration or
                delete data.
              </p>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <ol className="mb-6 list-decimal space-y-3 pl-6">
              ...
              <li>
                ...
                users, page views, and verified visitors. These numbers update automatically when
                the workflow runs.
              </li>
            </ol>

            <p className="mb-4">
              A companion script emails a formatted summary to the project team, including top
              pages, engagement trends, and the verified visitor count.
            </p>

            <div className="rounded-lg bg-blue-50 border border-blue-200 p-4 text-sm text-blue-900">
              <p className="font-semibold mb-1">Workflow trigger</p>
              <p>
                The workflow can also be triggered manually via <code>workflow_dispatch</code>.
                Manual runs include additional diagnostic output (channel and hostname breakdowns)
                that is suppressed during scheduled runs to keep logs clean and avoid exposing
                detailed analytics data unnecessarily.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                Switching to <strong>Active Users</strong> (23,766) didn&apos;t help - the number
                was still far too high. The question was: where was all this traffic coming from?
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                Investigation via the GA4 Data API revealed the answer. By breaking down active
                users by <code>hostName</code>, we discovered:
              </p>
              ...
              <ul className="mb-4 list-disc space-y-2 pl-6">
                <li>
                  ...
                  tests using real Chromium browsers against a local preview server. Because the
                  tests execute in real browsers, GTM and GA4 tags fire normally, creating real GA4
                  sessions.
                </li>
                <li>
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                ...
                arrives at <code>technologyadoptionbarriers.org</code>, we extract only the
                production hostname row from the GA4 hostname breakdown.
              </p>
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                GA4 offers both property-level data filters and API-level{' '}
                <code>dimensionFilter</code> parameters. We attempted three different approaches to
                filter at the API level:
              </p>
              <ol className="mb-4 list-decimal space-y-2 pl-6">
                <li>
                  <code>dimensionFilter</code> with <code>inListFilter</code> on{' '}
                  <code>hostName</code> - filter was silently ignored
                </li>
                <li>
                  <code>dimensionFilter</code> with <code>stringFilter</code> on{' '}
                  <code>hostName</code> - filter was silently ignored
                </li>
                <li>
              ...
              <p className="mb-4">
                ...
                using <code>metricAggregations: TOTAL</code> without row-level dimensions. Rather
                than continue debugging an opaque API behavior, we adopted the pragmatic approach:
                fetch the breakdown, filter in JavaScript.
              </p>
              <p className="mb-4">
            ...
            <div className="mb-8">
              ...
              <ul className="mb-4 list-disc space-y-2 pl-6">
                <li>
                  <strong>Active users</strong> as defined by GA4 (users who had an engaged session
                  or first visit within the reporting period)
                </li>
                <li>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                If your CI/CD pipeline runs E2E tests in real browsers (Playwright, Cypress,
                Selenium) against a site that has analytics tags, those tests will generate real
                analytics data. This is not a bug - it&apos;s expected behavior. Plan for it from
                day one by either excluding localhost at the property level or filtering in your
                reporting pipeline.
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                The GA4 Data API&apos;s <code>dimensionFilter</code> parameter does not always
                behave as documented, especially when combined with <code>metricAggregations</code>{' '}
                and no row-level dimensions. If you encounter filter issues, fetch the full
                breakdown and filter in your application code. It&apos;s more explicit and
                debuggable.
              </p>
            </div>
          ...
          <section className="pt-8 border-t border-gray-200">
            <p className="text-sm text-gray-600 italic">
              This page documents the analytics methodology as of February 2026. The verified
              visitors approach was developed iteratively during issue #333 of the TABS project.
            </p>
          </section>
        </article>
      </MakingOfTabsNav>
