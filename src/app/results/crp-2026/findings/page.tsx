        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className={SECTION_CLASSES}>
            <p className={PARAGRAPH_CLASSES}>
              ...
              each of the three CRP sample definitions. This ensures that any finding can be
              validated against the researcher&rsquo;s chosen dataset.
            </p>
          </section>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className={PARAGRAPH_CLASSES}>
              Cohen&rsquo;s d measures the standardized difference between group means. Values of
              |d| &lt; 0.2 are negligible, 0.2&ndash;0.5 small, 0.5&ndash;0.8 medium, and &gt; 0.8
              large. Each comparison is computed separately for each result group.
            </p>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className={PARAGRAPH_CLASSES}>
              Welch&rsquo;s t-tests compare two groups (unequal variance assumed). One-way ANOVA
              tests whether means differ across three or more groups. All tests are two-tailed with
            ...
            <ul className="text-sm text-gray-600 space-y-1">
              ...
              <li>
                <Link href="/results/crp-2026" className="text-blue-600 hover:underline">
                  &larr; Back to CRP 2026 Overview
                </Link>
              </li>
            </ul>
          </section>
...
export default CrpFindingsPage
