...
describe('assetPath utility', () => {
  ...
  it('should prepend basePath when NEXT_PUBLIC_BASE_PATH is set', () => {
    process.env.NEXT_PUBLIC_BASE_PATH = '/technologyadoptionbarriers.org'
    expect(assetPath('/logo.png')).toBe('/technologyadoptionbarriers.org/logo.png')
  })

  it('should handle paths with subdirectories', () => {
    process.env.NEXT_PUBLIC_BASE_PATH = '/technologyadoptionbarriers.org'
    expect(assetPath('/images/hero.jpg')).toBe('/technologyadoptionbarriers.org/images/hero.jpg')
  })

  it('should handle root path', () => {
    process.env.NEXT_PUBLIC_BASE_PATH = '/technologyadoptionbarriers.org'
    expect(assetPath('/')).toBe('/technologyadoptionbarriers.org/')
  })
})
