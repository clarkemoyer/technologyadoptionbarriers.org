    ...
    result["demographic_sources"] = {
        ...
        "platform_demographics": {
            ...
            "prescreener_fields": {
                ...
                "handedness": "Left/right-handed/ambidextrous",
                "marital_status": "Marital/relationship status",
                "number_of_children": "Number of children",
                "vision_impairment": "Vision impairment or blindness",
                "hearing_impairment": "Hearing impairment or deafness",
                "health_conditions": "Long-term health conditions or disabilities",
                "political_affiliation": "Political affiliation or orientation",
                "religious_affiliation": "Religious affiliation",
            },
            "prescreener_note": "Up to 15 prescreener filters can be selected per export (configurable twice before locking). Prolific offers hundreds of prescreener categories via GET /api/v1/filters/. The fields listed above are representative examples; the full catalog is available programmatically.",
            "fields": {
                "age": "Participant age",
                "sex": "Biological sex",
