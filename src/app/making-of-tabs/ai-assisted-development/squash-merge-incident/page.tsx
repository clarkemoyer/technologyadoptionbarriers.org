        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <div className="mb-8 rounded-xl border border-red-200 bg-red-50 p-6">
            ...
            <p className="text-sm text-red-800">
              ...
              files, destroying security fixes, accessibility features, statistical analysis code,
              and research data. A second squash merge downgraded GitHub Actions versions across 30
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className="mb-4">
              During a batch merge session managed by Claude Code, PR #927 (a 5-file feature adding
              an effect size chart) was squash-merged into main. The branch had been forked from
              main approximately 27 hours earlier. During that window, 35 other PRs had been merged
              to main.
            </p>
            <p className="mb-4">
              The squash merge silently reverted every change to every file the branch touched
              &mdash; not just the 5 files that were part of the feature, but 62 additional files
              that had been modified between the branch&apos;s fork point and the merge time.
              GitHub&apos;s diff showed 67 changed files, but this red flag was missed.
            </p>
            <p className="mb-4">
              A second squash merge (PR #803) was identified during the investigation. It had the
              same root cause: a stale Dependabot-style branch squash-merged without rebasing,
              reverting action version upgrades across 30 workflow files.
            </p>
          </section>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className="mb-4">
              ...
              HEAD and the branch tip. When a branch is behind main, this diff includes stale
              versions of every file the branch touches. Squash merge treats those stale versions as
              the &ldquo;intended state&rdquo; and overwrites whatever is currently on main.
            </p>
            ...
            <p className="mb-4">
              Regular merge commits do not have this problem. A merge commit preserves both
              histories and only applies the branch&apos;s own changes. Rebase merge also avoids the
              issue because it replays commits individually onto the current main.
            </p>
          </section>
            ...
            <div className="space-y-4 mb-6">
              <div className="rounded-xl border border-red-200 bg-red-50 p-4">
                ...
                <ul className="list-disc pl-5 text-sm text-red-800 space-y-1">
                  ...
                  <li>
                    JSON-LD sanitization on media page (PR #1226) &mdash; re-exposed XSS vector
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-xl border border-orange-200 bg-orange-50 p-4">
                ...
                <ul className="list-disc pl-5 text-sm text-orange-800 space-y-1">
                  <li>
                    Skip-to-content keyboard navigation (PR #1275) &mdash; removed from layout
                  </li>
              ...
              <div className="rounded-xl border border-yellow-200 bg-yellow-50 p-4">
                ...
                <ul className="list-disc pl-5 text-sm text-yellow-800 space-y-1">
                  <li>
                    ...
                    <code className="text-xs bg-yellow-100 px-1 rounded">cohens_d</code> reverted
                    from tuple to float return
                  </li>
                  <li>
                    Welch&apos;s t-test confidence intervals removed (5-tuple reverted to 3-tuple)
                  </li>
                  <li>
                    Role categorization patterns for &ldquo;Other&rdquo; responses deleted (PR
                    #1279)
                  </li>
              ...
              <div className="rounded-xl border border-blue-200 bg-blue-50 p-4">
                ...
                <ul className="list-disc pl-5 text-sm text-blue-800 space-y-1">
                  <li>
                    JSON schema validation script and CI step (PR #1077) &mdash; removed from
                    pipeline
                  </li>
                  <li>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className="mb-4">
              ...
              the reverted code was still valid &mdash; it was simply an older version. Detection
              came through a combination of:
            </p>
            <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <li>
                ...
                <code className="text-xs bg-gray-200 px-1 rounded">(d, ci_lower, ci_upper)</code>{' '}
                but the reverted function returned a bare float
              </li>
            </ul>
            <p className="mb-4">
              <strong>Key lesson:</strong> The file count in a PR diff is a critical signal. A
              feature PR showing significantly more changed files than expected is a red flag that
              the branch is stale and the merge will carry unintended changes.
            </p>
          </section>
              ...
              <table className="w-full text-sm border border-gray-200 rounded-lg">
                ...
                <tbody>
                  <tr className="border-b border-gray-100">
                    ...
                    <td className="p-3">
                      30 source/config files restored, 30 workflow files restored, Node.js 24 env
                      var re-applied, package.json dependencies fixed, Python analysis functions
                      restored (cohens_d CIs, mean_ci, welch_t_test CIs, role categorization
                      patterns)
                    </td>
                  </tr>
                  <tr className="border-b border-gray-100">
                    ...
                    <td className="p-3">
                      ...
                      Jules), 4 test suites (GTM XSS, Quotes client, teaching series,
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p>
                    ...
                    are now permitted. This is a hard block &mdash; GitHub will reject any attempt
                    to squash merge, regardless of who or what initiates it.
                  </p>
                </div>
              </div>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <ul className="list-disc pl-6 space-y-3 mb-6">
              ...
              <li>
                <strong>Git operations need guardrails too.</strong> We had extensive CI, testing,
                and code review guardrails. But the merge strategy itself was unconstrained. The
                agent chose squash merge as a reasonable default &mdash; and it is reasonable in
                most cases. The failure mode only appears with stale branches, which are common
                during batch merge sessions.
              </li>
              <li>
                <strong>AI agents make systematic errors.</strong> A human might notice that a
                5-file PR has a 67-file diff and pause. The agent processed the diff size as
                expected. AI agents need explicit rules for red flags that humans catch intuitively.
              </li>
              <li>
          ...
          <section className="pt-8 border-t border-gray-200">
            <p className="text-sm text-gray-600 italic">
              ...
              fixed the issue. The restoration PRs, repository setting change, and this
              documentation were all part of the remediation.
            </p>
          </section>
        </article>
      </MakingOfTabsNav>
