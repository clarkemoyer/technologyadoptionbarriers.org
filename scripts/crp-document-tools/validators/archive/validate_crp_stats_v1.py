...
import csv, math, re, zipfile, io
from xml.etree import ElementTree as ET

CSV_PATH = "/sessions/pensive-zen-darwin/mnt/! Clarke Moyer Smeal CRP - TABS/05 TABS Survey Support/TABS Survey Data/Technology_Adoption_Barriers_Survey_FIRST_V2_ONLY (3-30-2026 2033 EST).csv"
DOCX_PATH = "/sessions/pensive-zen-darwin/mnt/! Clarke Moyer Smeal CRP - TABS/Clarke Moyer - DBA Culminating Research Project - Product Development (4-2-2026 0936 EST).docx"
