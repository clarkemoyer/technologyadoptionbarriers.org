        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className={SECTION_CLASSES}>
            <p className={PARAGRAPH_CLASSES}>
              This page presents the frozen, moment-in-time dataset (N={d(CRP_SAMPLE_SIZE)}) used
              for the TABS Culminating Research Project (CRP). Unlike the{' '}
            ...
            <p className={PARAGRAPH_CLASSES}>
              Freezing the dataset ensures that every statistic, table, and figure in the final
              paper can be independently reproduced. The live pipeline continues to collect data
              beyond N=
            ...
            <div className="space-y-8">
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <p className={PARAGRAPH_CLASSES}>
                  ...
                  automatically included; remaining slots are filled by quality-ranked responses
                  from lower tiers.
                </p>
                <ul className={BODY_LIST_CLASSES}>
                  <li>
                    <strong>Tier 1 - Conservative Clean (auto-include):</strong> All responses
                    passing every quality gate: 3/3 IRI attention checks, duration ≥ 540s, reCAPTCHA
                    ≥ 0.5, no straightlining, no auth flags (N={d(CRP_CONSERVATIVE_CLEAN)})
                  </li>
                  <li>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <p className={PARAGRAPH_CLASSES}>
                  ...
                  indicators, scaled to a 100-point range. The six indicators are: IRI attention
                  check performance (35 pts), survey completion duration (20 pts), reCAPTCHA
                  bot-detection score (15 pts), Prolific authentication flags (15 pts), full
                  straightlining detection (8 pts), and partial straightlining / within-person
                  response variance (7 pts).
                </p>
                <p className="text-gray-600 font-sans text-sm">
                  All N={d(CRP_SAMPLE_SIZE)} responses are included in the CRP dataset. The quality
                  score determines Tier 3 selection priority and supports sensitivity analysis
                  across sample definitions (Conservative Clean vs. full CRP sample).
                </p>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <p className={PARAGRAPH_CLASSES}>
                  ...
                  protocol. All direct identifiers (Prolific PIDs, IP addresses, geolocation data)
                  are removed prior to release. Indirect identifiers (organization size, industry
                  sector) are retained at categorical granularity to support meaningful analysis
