      ...
      <MakingOfTabsNav>
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-10 text-gray-800">
            <p className="mb-6">
              At Technology Adoption Barriers (TABS), ensuring the factual accuracy and academic
              rigor of our content is paramount. To achieve this at scale, we employ advanced Large
              Language Models (LLMs) to conduct exhaustive, read-only validity checks across our
            ...
            <p className="mb-6">
              ...
              knowledge bases of models like Gemini 3.1 Pro, we can cross-reference our claims,
              dates, and author attributions against established literature with unprecedented speed
              and accuracy.
            </p>
            ...
            <p className="mb-4">
              ...
              independent auditor, scanning the codebase and extracting factual claims without
              making any modifications. The primary goal is to identify:
            </p>
            ...
            <blockquote className="border-l-4 border-blue-600 pl-4 italic text-gray-700 mb-6 bg-gray-50 p-4 rounded-r-md">
              &quot;I want to do a full validity check on the public content on the site. I am
              looking for false statements and wrong academic findings or other errors. Don&apos;t
              make any changes; your goal is to find and present the factual errors in the content.
              Then we will address them one by one.&quot;
            </blockquote>
