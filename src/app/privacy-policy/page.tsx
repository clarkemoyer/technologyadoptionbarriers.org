    ...
    <div className="pt-[140px] pb-[54px]">
      <div className="py-[27px] w-[90%] md:w-[80%] mx-auto">
        <div id="aria-font">
          ...
          <p className="text-[14px] text-gray-500 pb-[10px] leading-[24px] font-[500]">
            Our website address is: https://technologyadoptionbarriers.org
          </p>
          ...
          <ul className="list-inside list-disc space-y-[4px] pb-[1em]">
            ...
            <li className="text-[14px] text-gray-500 leading-[24px] font-[500]">Use cookies.</li>
            <li className="text-[14px] text-gray-500 leading-[24px] font-[500]">
          ...
          <p className="text-[14px] text-gray-500 pb-[10px] leading-[24px] font-[500] italic">
          ...
          <p className="text-[14px] text-gray-500 pb-[10px] leading-[24px] font-[700] mt-[1.5em]">
