      ...
      <MakingOfTabsNav>
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className="mb-6">
              At the end of an evening session, Claude Code presents a status report. Every task has
              a clear disposition:
            </p>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p>
                    PR #1293 - CI passed, auto-merge is enabled. It will merge on its own once
                    status checks propagate. No human intervention needed.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p>
                    ...
                    Copilot&apos;s coding agent. While the human sleeps, Copilot picks up each
                    issue, creates a branch, writes the implementation, opens a PR, and moves on to
                    the next.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p>
                  ...
                  autonomously on assigned issues. Two AI agents, different capabilities,
                  coordinated handoff.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  The pipeline does not stop when the human leaves. Auto-merge waits for CI checks
                  to pass and merges without intervention. Copilot picks up issues, writes code, and
              ...
              <div>
                ...
                <p>
                  The human decided to build Zotero integration. Claude Code executed the plan
                  across multiple PRs and issues. Copilot handles the follow-up work overnight. The
                  human reviews the results in the morning. Direction is human; execution is
                  distributed across agents; quality is enforced by CI.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <ul className="list-disc pl-6 space-y-2 mb-6">
              ...
              <li>
                Set up the pyzotero MCP server across Claude Desktop, VS Code, and Claude Code
              </li>
              <li>
