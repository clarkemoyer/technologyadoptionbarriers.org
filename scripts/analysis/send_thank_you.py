...
def send_thank_you_to_pids(
    ...
    Args:
        pids: Participant IDs to message. Duplicates are removed (order preserved).
    ...
    Returns:
        ...
        not_found, failed.
    """
    # Deduplicate while preserving order (dict.fromkeys() maintains insertion order in Python 3.7+)
