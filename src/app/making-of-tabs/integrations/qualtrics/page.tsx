        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                ...
                that wraps common API operations. This client is used by both GitHub Actions
                workflows and local development scripts. Key functions include survey listing,
                definition export, question fetching, and metrics retrieval.
              </p>
            </div>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <div className="rounded-lg bg-amber-50 border border-amber-200 p-4 text-sm text-amber-900">
              ...
              <p>
                Write workflows require explicit confirmation. The copy and apply workflows include
                a safety gate where you must type <code>APPLY</code> to confirm the operation. This
            ...
            <div className="mb-6">
              ...
              <div className="mb-4 rounded-lg border border-green-200 bg-green-50 p-4">
                ...
                <p className="text-sm text-green-800">
                  ...
                  the source and redirects to Prolific&apos;s completion URL.
                </p>
              </div>
            </div>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className="text-sm text-gray-600 italic">
              This entire process can be completed in under 30 minutes using the automated
              workflows. All steps are documented in <code>PROLIFIC_INTEGRATION.md</code>.
            </p>
          </section>
          ...
          <section className="pt-8 border-t border-gray-200">
            <p className="text-sm text-gray-600 italic">
              This page documents the Qualtrics integration as of February 2026. For the most
              current API details, see <code>qualtrics-api-cheatsheet.md</code> in the project
              repository.
            </p>
          </section>
        </article>
