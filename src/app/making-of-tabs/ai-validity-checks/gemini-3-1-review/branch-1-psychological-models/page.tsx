      ...
      <MakingOfTabsNav>
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <p className="mb-4">
              Fred Davis&apos;s (1989) seminal Technology Acceptance Model was rigorously checked.
              The site correctly identifies Perceived Usefulness (PU) and Perceived Ease of Use
              (PEOU) as the primary determinants of technology acceptance. The historical context of
              TAM adapting TRA specifically for information systems is factually sound.
            </p>
