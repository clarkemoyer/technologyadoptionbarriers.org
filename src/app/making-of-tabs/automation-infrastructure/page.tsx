  ...
  return (
    <main className={ARTICLE_CLASSES}>
      ...
      <nav className="text-sm text-gray-500 mb-6" aria-label="Breadcrumb">
        <Link href="/making-of-tabs" className="hover:underline">
          Making of TABS
        </Link>
      ...
      <p className="text-gray-600 mb-8">
        ...
        main chains: the hands-off coding workflow that takes a GitHub Issue to a merged PR without
        any human writing code, and the daily data pipeline that processes Prolific submissions,
        runs analysis, and commits results - all without a human pressing a button.
      </p>
      ...
      <section className="mb-10">
        ...
        <p className="mb-4">
          Every external API is accessed through either an official first-party client library or a
          centralized TypeScript/Python module that wraps the REST API directly. No third-party API
          wrappers are used.
        </p>
        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-gray-200 p-5">
            ...
            <p className="text-sm text-gray-700 mb-2">
              Survey export, embedded data, and quota operations use the official Qualtrics REST API
          ...
          <div className="rounded-xl border border-gray-200 p-5">
            ...
            <p className="text-sm text-gray-700 mb-2">
              ...
              <code className="text-xs bg-gray-100 px-1 rounded">googleapis</code> SDKs from Google.
              Service account authentication is used; credentials are stored in GitHub Secrets and
