        ...
        <section className="mb-10 text-gray-800">
          ...
          <div className="rounded-lg bg-blue-50 border border-blue-200 p-4 text-sm font-sans mb-6">
            ...
            <ul className="list-disc pl-5 space-y-1 text-blue-800">
              <li>Cache hit ratio: 70&ndash;90% for static assets</li>
              <li>TTFB improvement: 30&ndash;50% from CDN proximity</li>
              <li>LCP improvement: 15&ndash;30%</li>
              <li>Bandwidth savings: 40&ndash;60%</li>
            </ul>
          </div>
        </section>
            ...
            <table className="min-w-full border border-gray-200 text-sm font-sans">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="px-4 py-2 border-b">10&ndash;30% smaller file sizes</td>
                </tr>
                <tr className="bg-gray-50">
