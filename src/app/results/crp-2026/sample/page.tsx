        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className={SECTION_CLASSES}>
            <p className={PARAGRAPH_CLASSES}>
              Demographics are computed independently for each of the three primary result groups.
              This allows researchers to verify that the composition of their chosen dataset matches
              their generalizability requirements. All statistics on this page are generated by the
          ...
          <section className="mb-12 text-gray-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
              <div className="bg-teal-50 border border-teal-200 rounded-lg p-5">
                ...
                <p className="text-sm text-teal-800 mb-3">
                  ...
                  Q1&ndash;Q9). These are <strong>role-specific, organizational</strong>{' '}
                  demographics directly relevant to the research questions.
                </p>
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-5">
                ...
                <p className="text-sm text-purple-800 mb-3">
                  ...
                  completion. Includes <strong>base demographic fields</strong> (always exported)
                  and <strong>prescreener fields</strong> (up to 15 selectable per export from
            ...
            <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4 mt-4">
              ...
              <p className="text-sm text-indigo-800 mb-3">
                ...
                responses to flag discrepancies (e.g., a participant reporting &ldquo;CIO at a
                10,000+ company&rdquo; in Qualtrics but &ldquo;Student&rdquo; or &ldquo;Company
                Size: 1&ndash;10&rdquo; in Prolific).
              </p>
              ...
              <div className="mt-3 pt-3 border-t border-indigo-200">
                ...
                <p className="text-xs text-indigo-700">
                  ...
                  <strong>Marital Status</strong>, <strong>Health Conditions</strong>, and more.
                  These can be used to augment aggregate demographic reports and assess sample
          ...
          <section className="mb-12 text-gray-800">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <p className="text-sm text-green-900">
                ...
                level, household income), totaling 7 of the 15-filter API maximum. Screener
                responses enable cross-validation against Qualtrics survey answers (e.g., Prolific
                ...
                >
                  ...
                  {hasDemoData ? (
                    ...
                    <p className="text-sm text-red-600 font-medium mt-2">
                      {DATA_UNAVAILABLE} Demographics data missing from
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className={PARAGRAPH_CLASSES}>
              Participants who selected &ldquo;Other (please specify)&rdquo; for their executive
              role (Q1) provided a free-text description. The analysis pipeline categorizes these
              responses into broad groups using keyword matching to provide insight into the
              composition of the &ldquo;Other&rdquo; category without exposing individual responses.
            </p>
            <div className="overflow-x-auto my-6">
              <table className="w-full border-collapse font-sans text-sm">
                <thead>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
              <p className="text-sm text-amber-900">
                ...
                analysis pipeline using keyword matching on free-text responses. A single response
                is assigned to the first matching category. &ldquo;C-Suite Adjacent&rdquo; and
                &ldquo;VP / SVP&rdquo; respondents may represent roles functionally equivalent to
                the named C-suite titles but with different organizational naming conventions.
                Researchers may wish to consider reclassifying these into the Technical or
                Non-Technical grouping for sensitivity analyses.
              </p>
            </div>
          </section>
          ...
          <section className="mb-12 text-gray-800">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              <p className="text-sm text-blue-900">
                ...
                self-reported Qualtrics responses (Q1&ndash;Q9) and displayed as category-level
                counts and percentages only. Prolific platform demographics (base fields: age, sex,
                ...
                not displayed on this page to protect participant privacy. No individual-level data
                is displayed from either source.
              </p>
            </div>
          </section>
