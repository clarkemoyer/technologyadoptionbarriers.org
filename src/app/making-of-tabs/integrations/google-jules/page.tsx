      ...
      <MakingOfTabsNav>
        <article className={ARTICLE_CLASSES}>
          ...
          <p className="mb-8 text-lg sm:text-xl text-gray-600 font-sans">
            ...
            concurrency and vast context window to handle visualization, content updates, and
            complex frontend work at scale.
          </p>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <p className="mb-4">
              ...
              understand the codebase, write and test code, and eventually open a pull request
...
5. Jules writes code, validates builds, and opens a PR`}
          ...
          <section className="mb-10 text-gray-800">
            ...
            <ul className="list-disc pl-5 space-y-2 mb-6 font-sans text-base">
              ...
              <li>
                <strong>@jules on issue comments:</strong> Does <em>NOT</em> unblock waiting
                sessions (tested and confirmed).
              </li>
              <li>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <ul className="list-disc pl-5 space-y-2 mb-6 font-sans text-base">
              <li>
                Tasks can be instantiated via the Jules CLI, the web UI, or our custom GitHub
                Action.
              </li>
              <li>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <p className="mb-4">
              Jules and Copilot are <strong>complementary, not competing</strong>. Copilot is
              heavily integrated into our code review cycle and daily CI/CD routines, while Jules
              acts as a massive parallel workforce capable of tackling broad, multi-file frontend
              scopes at once.
            </p>
            <p className="mb-4">
              <strong>Privacy:</strong> When triggered, Jules clones the repository to a secure
              Google Cloud VM, processes the requested changes locally within that environment, and
              returns the result via a Pull Request. Data is handled securely following
              Google&apos;s stringent cloud security protocols.
            </p>
          </section>
        </article>
      </MakingOfTabsNav>
