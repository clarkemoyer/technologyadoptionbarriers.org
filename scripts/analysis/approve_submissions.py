...
def main():
    ...
    if send_thank_you and not dry_run and clean_pids:
        ...
        try:
            # Deferred import: only loads when needed, avoiding unnecessary
            # Prolific messaging client initialization in dry-run scenarios.
            ...
            error_msg = f"Failed to send thank-you messages for study {study_id}: {e}"
