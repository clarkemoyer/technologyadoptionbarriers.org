      ...
      <div className={`flex ${flexDirection} items-start gap-[59px]`}>
        ...
        <div className="flex-1 text-center md:text-left">
          <div className="flex mb-5">
            <div className="h-[3px] bg-tabs-orange w-[18%]"></div>
          </div>

          <h3 className="text-[28px] font-[600] text-gray-800 leading-[36px] pb-[10px]">
            {subtitle}
          </h3>

          <div className="text-gray-800 text-[18px] leading-[24px] font-[500]" id="lato-font">
            {description}
          </div>
