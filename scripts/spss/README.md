...
| Mahalanobis outliers (Barriers)       | `REGRESSION /DEPENDENT row_index /METHOD=ENTER B1 TO B18 /SAVE MAHAL LEVER`               | max D-squared in Residuals Statistics; per-case saved as MAH_1 (Mahalanobis) and LEV_1 (leverage); DV is a row-number proxy so Cook's D is not meaningful and is not saved |
| Mahalanobis outliers (Readiness)      | same with `R1 TO R17`; saves MAH_2 and LEV_2                                              | same                                                                                                                                                                       |
| Mahalanobis outliers (Maturity)       | same with `M1 TO M8`; saves MAH_3 and LEV_3                                               | same                                                                                                                                                                       |
