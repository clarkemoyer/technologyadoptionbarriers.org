        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                When a Prolific participant starts the TABS study, Prolific opens the Qualtrics
                survey URL and appends three URL parameters:
              </p>
              <ul className="mb-4 list-disc space-y-2 pl-6">
                <li>
              ...
              <p className="mb-4">
                Qualtrics captures these as <strong>Embedded Data</strong> fields in the Survey
                Flow, which links each survey response back to the Prolific submission. At the end
                of the survey, the respondent is redirected to the appropriate destination based on
                the Survey Flow logic.
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="mb-4 text-sm text-gray-600 italic">
                ...
                page for the full two-branch Survey Flow architecture, including the redirect
                lockdown pattern.
              </p>
            </div>
          </section>
          ...
          <section className="pt-8 border-t border-gray-200">
            <p className="text-sm text-gray-600 italic">
              This page documents the Prolific integration as of February 2026. For the complete
              setup guide and annual rollover checklist, see <code>PROLIFIC_INTEGRATION.md</code> in
