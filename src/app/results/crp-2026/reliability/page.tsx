...
const CrpReliabilityPage = () => {
  ...
  // Pull the new keys (PR #1837) from crp-validation.json's primary sample
  const primarySample = findPrimarySample(crpValidationData as unknown as ValidationLike)
