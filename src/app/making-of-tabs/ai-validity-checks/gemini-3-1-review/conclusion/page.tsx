          ...
          <section className="mb-10 text-gray-800">
            ...
            <div className="p-6 bg-green-50 border border-green-200 rounded-lg mb-6">
              ...
              <p className="text-green-700">
                The review found{' '}
                <strong>
                  zero false statements, zero incorrect academic attributions, and zero factual
                  errors
                </strong>{' '}
            ...
            <p className="mb-4">
              The use of an advanced LLM like Gemini 3.1 Pro to conduct this read-only validity
              check provides an additional layer of assurance for our readers. By systematically
              cross-referencing our content against a vast internal knowledge base, we can
              confidently state that the educational materials provided by TABS meet stringent
