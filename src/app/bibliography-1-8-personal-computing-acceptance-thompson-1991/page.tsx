        ...
        <section className={SECTION_CLASSES}>
          ...
          <section className="mb-6">
            ...
            <ul className={BODY_LIST_CLASSES}>
              ...
              <li>
                <strong>Following Models or Theories:</strong> <em>Following Models:</em> Taylor and
                Todd (1995) - Understanding Information Technology Usage: A Test of Competing
                Models; Goodhue and Thompson (1995) - Task-Technology Fit and Individual
                Performance; numerous subsequent technology adoption models building on these
                foundations. <em>Following Theories:</em> Subsequent refinements of the Technology
                Acceptance Model (TAM); extensions incorporating social influences and
                organizational factors; models examining utilization patterns rather than mere
                adoption
              </li>
            </ul>
          </section>
          ...
          <section className={SECTION_CLASSES}>
            ...
            <ol className="list-decimal list-inside space-y-3 text-sm">
              ...
              <li>
                ...
                <em>Academy of Management Review</em>, 4(4), 527-538.
              </li>
              <li>
                ...
                <em>IEEE Transactions on Engineering Management</em>, EM-29(1), 28-45.
              </li>
              <li>
                Cheney, P. H., Mann, R. I., and Amoroso, D. L. (1986). Organizational factors
                affecting the success of end-user computing.{' '}
                <em>Journal of Management Information Systems</em>, 3(1), 65-80.
              </li>
            </ol>
            <p className={PARAGRAPH_CLASSES}>
