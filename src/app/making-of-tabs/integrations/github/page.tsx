  ...
  → Code Review (Copilot + human) → Merge Queue → Deploy → Lighthouse`}
      ...
      <section className="mb-10 text-gray-800">
        ...
        <div className="mb-8">
            ...
            <table className="min-w-full border border-gray-200 text-sm font-sans">
              ...
              <tbody>
                ...
                <tr className="bg-gray-50">
                  ...
                  <td className="px-4 py-2 border-b">TypeScript errors, static export failures</td>
                </tr>
                <tr>
          ...
          <p className="mb-4">
            Concurrency control ensures that pushing a new commit to a PR cancels any in-progress CI
            run for the same ref, saving compute and avoiding stale results.
          </p>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="mb-4">
            When CI passes on <code>main</code>, the deployment workflow builds the static site with{' '}
            <code>output: &apos;export&apos;</code> and publishes the <code>out/</code> directory to
            the <code>github-pages</code> environment. The site is served at the custom domain{' '}
            <code>technologyadoptionbarriers.org</code> via a CNAME record managed in Cloudflare.
          </p>
        </div>
      ...
      <section className="mb-10 text-gray-800">
        ...
        <div className="mb-8">
          ...
          <p className="mb-4">
            ...
            missing ARIA labels, type safety gaps, and unused code. Review comments appear inline on
            the PR diff and must be addressed before merging.
          </p>
        </div>
        ...
        <div className="mb-8">
          ...
          <ul className="list-disc pl-5 space-y-2 mb-6 font-sans text-base">
            <li>
              ...
              patch) into separate PRs, with major versions handled individually for careful review.
      ...
      <section className="mb-10 text-gray-800">
        ...
        <ul className="list-disc pl-5 space-y-2 mb-6 font-sans text-base">
          <li>
            ...
            <code>impact.json</code>, creates a PR via <code>peter-evans/create-pull-request</code>,
            and auto-merges it
          </li>
          <li>
      ...
      <section className="mb-10 text-gray-800">
        ...
        <p className="mb-4">
          A TypeScript release-notes generator (<code>scripts/generate-release-notes.ts</code>) uses
          the GitHub CLI to query merged PRs and closed issues between Git refs. It separates human
          contributors from bots, categorises changes into user-facing and internal improvements,
          and produces structured Markdown with sections for each external integration.
        </p>
        <p className="mb-4">
      ...
      <section className="mb-10 text-gray-800">
        ...
        <ul className="list-disc pl-5 space-y-3 mb-6 font-sans text-base">
          <li>
            ...
            environment-scoped secrets (not repository-level) limits blast radius — a workflow only
            has access to the environment it declares.
          </li>
          <li>
            <strong>Sharded E2E pays off fast.</strong> Splitting Playwright across 4 shards cuts
            E2E wall time by ~75%. The overhead of spinning up extra runners is negligible compared
            to running 50+ test files sequentially.
          </li>
          <li>
