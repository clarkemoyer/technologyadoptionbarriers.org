...
const GitHubIntegrationPage = () => {
      ...
      <MakingOfTabsNav>
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <p className="mb-4">
              Most projects treat GitHub as a place to store code and open pull requests. TABS uses
              it as a <strong>full DevOps platform</strong>. Every automated task — from daily
              analytics reports to weekly participant-data collection — runs inside GitHub Actions,
              is gated by environment secrets, and produces auditable step summaries.
            </p>
  ...
  → Code Review (Copilot + human) → Merge Queue → Deploy → Lighthouse`}
          ...
          <section className="mb-10 text-gray-800">
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                ...
                entry, and push to <code>main</code>. It executes five stages sequentially, then
                fans out into four parallel shards for E2E testing:
              </p>
              ...
              <p className="mb-4">
                Concurrency control ensures that pushing a new commit to a PR cancels any
                in-progress CI run for the same ref, saving compute and avoiding stale results.
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                ...
                dynamically discovers every HTML page in the build output and runs Lighthouse
                against each one, providing performance, accessibility, best-practices, and SEO
                scores.
              </p>
            </div>
          </section>
              ...
              <table className="min-w-full border border-gray-200 text-sm font-sans">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="px-4 py-2 border-b">
                      Format, lint, test, build, E2E (4 shards)
                    </td>
                  </tr>
                  <tr className="bg-gray-50">
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-2 border-b">
                      Collect participant data from Prolific API
                    </td>
                  </tr>
                  <tr className="bg-gray-50">
                    ...
                    <td className="px-4 py-2 border-b">
                      API connectivity and authentication check
                    </td>
                  </tr>
                  <tr>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                ...
                missing ARIA labels, type safety gaps, and unused code. Review comments appear
                inline on the PR diff and must be addressed before merging.
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                A <code>CODEOWNERS</code> file maps file paths to responsible reviewers. This
                ensures that changes to security-sensitive files (workflows, environment configs,
                governance docs) always require review from the appropriate owner.
              </p>
            </div>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <p className="mb-4">
              Several workflows act as <strong>data pipelines</strong> — they fetch data from
              external APIs, update JSON files in the repository, and create auto-merge PRs. This
              keeps the site&rsquo;s displayed metrics current without manual intervention:
            </p>
            <ul className="list-disc pl-5 space-y-2 mb-6 font-sans text-base">
              <li>
              ...
              <li>
                <strong>Qualtrics metrics update</strong> — fetches survey response counts and
                updates <code>qualtrics-metrics.json</code>, also auto-merged
              </li>
              <li>
            ...
            <p className="mb-4">
              ...
              , using utility functions from <code>src/lib/github-utils.ts</code> that write
              Markdown tables and status indicators to <code>GITHUB_STEP_SUMMARY</code>.
            </p>
          </section>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <p className="mb-4">
              ...
              uses the GitHub CLI to query merged PRs and closed issues between Git refs. It
              separates human contributors from bots, categorises changes into user-facing and
              internal improvements, and produces structured Markdown with sections for each
          ...
          <section className="mb-10 text-gray-800">
            ...
            <p className="mb-4">
              The repository includes a complete set of GitHub-recognised community health files
              that appear automatically in the GitHub navigation:
            </p>
          ...
          <section className="mb-10 text-gray-800">
            ...
            <ul className="list-disc pl-5 space-y-3 mb-6 font-sans text-base">
              ...
              <li>
                <strong>Sharded E2E pays off fast.</strong> Splitting Playwright across 4 shards
                cuts E2E wall time by ~75%. The overhead of spinning up extra runners is negligible
                compared to running 50+ test files sequentially.
              </li>
              <li>
                <strong>Auto-merge data PRs carefully.</strong> The GA and Qualtrics pipelines
                auto-merge their data-update PRs. This works because (a) the PRs only modify
                specific JSON files, (b) CI validates the build after the update, and (c) the commit
                history is transparent. Manual review would create a bottleneck for daily data
                updates.
              </li>
              <li>
