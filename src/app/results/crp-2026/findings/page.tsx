...
const CrpFindingsPage = () => {
  const inferentialExtensionsProps = buildInferentialExtensionsProps(crpValidationData)
  return (
      ...
      <article className={ARTICLE_CLASSES}>
        ...
        <section className={SECTION_CLASSES}>
          <p className={PARAGRAPH_CLASSES}>
            ...
            each of the three CRP sample definitions. This ensures that any finding can be validated
