...
**168 substantive merged PRs (plus 53 routine daily pipeline / GA-stats PRs), 99 closed issues (excluding routine daily-report and broken-link auto-issues), 99 commits since v0.5.0.**
...
- **Zotero-backed bibliography reference validation** (CI + script) — hard-fails PRs introducing citations Zotero hasn't seen (#1597).
...
> Excludes 53 routine `chore: refresh platform-stats.json`, `Update daily pipeline data`, and `Update Google Analytics impact stats` auto-PRs. Substantive PRs only (168).
