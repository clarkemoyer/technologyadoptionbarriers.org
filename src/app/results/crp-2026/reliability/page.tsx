      ...
      <ResultsNav>
        <article className={ARTICLE_CLASSES}>
          ...
          <section className={SECTION_CLASSES}>
            ...
            <p className={PARAGRAPH_CLASSES}>
              All three TABS constructs demonstrate excellent internal consistency across the CRP
              2026 frozen dataset, with every Cronbach&rsquo;s alpha exceeding 0.84 across all three
              sample definitions. This indicates that the survey items within each construct are
              measuring the same underlying factor reliably, regardless of which inclusion criteria
              are applied.
            </p>
          </section>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <ul className="list-disc pl-5 space-y-2 mb-6 font-sans text-base">
              <li>
                All alphas exceed <strong>0.84</strong>, well above the commonly cited 0.70
                threshold, indicating excellent internal consistency across all constructs and
                samples.
              </li>
              <li>
                Reliability coefficients are <strong>stable across sample definitions</strong>,
                meaning the scales perform consistently whether computed on the strictest clean
                sample or the full CRP dataset.
              </li>
              <li>
              ...
              <li>
                ...
                {fmt(getMetricValue('alpha_maturity', 'conservative_clean'))}), which may reflect
                the smaller number of items in the Maturity scale (9 vs. 18&ndash;19).
              </li>
            </ul>
            <p className={PARAGRAPH_CLASSES}>
              The consistency of these results across three sample definitions demonstrates that the
              TABS scales are reliable instruments regardless of the inclusion criteria applied.
              This robustness is critical for supporting any downstream inferential analyses.
            </p>
          </section>
