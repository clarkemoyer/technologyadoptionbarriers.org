        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className={SECTION_CLASSES}>
            ...
            <p className="text-sm text-gray-500 font-sans">
              ...
              consistent with the EFA finding that 2 factors (not 4) best represent the data. Full
              CFA with cross-validation is planned at N=500.
            </p>
          </section>
          ...
          <section className={SECTION_CLASSES}>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 font-sans text-sm">
              ...
              <p className="text-amber-700">
                The Fornell-Larcker criterion fails for the Readiness-Maturity pair, while HTMT
                (.804) passes the .85 threshold. This reflects their shared &ldquo;organizational
                capability&rdquo; dimension: Readiness originates from the TRI/adoption literature
                and Maturity from CMMI/IT governance. Both scales provide distinct value to their
          ...
          <section className={SECTION_CLASSES}>
            ...
            <p className="text-sm text-gray-500 font-sans">
              Barriers correlate negatively with both Readiness (r = -.381) and Maturity (r =
              -.316), as expected: organizations with higher readiness and maturity perceive fewer
              barriers. Readiness and Maturity are positively correlated (r = .719), reflecting
              overlapping organizational capability constructs.
            </p>
          </section>
            ...
            {validationData.Barriers.itc_all_above_030 ? (
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4 font-sans text-sm mb-6">
                ...
                <p className="text-red-700 mt-1">
                  This item&rsquo;s CITC score falls below the conventional .30 threshold. The
                  current validation summary does not identify which item produced the minimum CITC,
                  so no item-specific rationale is reported here. Review the full item statistics in
                  the pipeline output for details.
                </p>
              </div>
            )}
