...
export const metadata: Metadata = {
  title: 'Data Analysis & Quality — Making of TABS',
  description:
  ...
  alternates: {
    canonical: '/making-of-tabs/data-analysis',
  },
}
  ...
  return (
    <main className="pt-20 sm:pt-[120px] min-h-screen bg-white">
      <article className={ARTICLE_CLASSES}>
        ...
        <h1 className={H1_CLASSES}>Data Analysis &amp; Quality</h1>
        ...
        <section className="mb-12 text-gray-800">
          ...
          <div className="flex flex-wrap gap-4 my-6">
            ...
            <Link
              href="/making-of-tabs/integrations/prolific/dashboard"
