        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className={SECTION_CLASSES}>
            <p className={PARAGRAPH_CLASSES}>
              ...
              groups. Each group represents an independent dataset with progressively less
              restrictive quality criteria. Researchers can use this comparison to assess how data
              cleaning decisions affect statistical conclusions.
            </p>
          </section>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className={PARAGRAPH_CLASSES}>
              ...
              each result group. The &Delta; column shows the difference from Conservative Clean
              (the strictest dataset). Deltas &gt; 0.05 are highlighted in amber.
            </p>
            <div className="overflow-x-auto">
              <table className="w-full text-sm font-sans border-collapse">
                <thead>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className={PARAGRAPH_CLASSES}>
              ...
              self-reported survey responses (Q1, Q4). These are organizational demographics from
              the TABS instrument. Prolific platform demographics (age, sex, ethnicity, plus
              prescreener fields like industry, company size, and occupation) are collected
              separately and can be used to cross-validate these survey responses via Prolific
              Participant ID.
            </p>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className={PARAGRAPH_CLASSES}>
              This analysis tests whether stricter quality filters disproportionately exclude
              certain demographics. A Chi-square test for independence is computed across the four
              result groups for role, organization size, and profit model.
            </p>
              ...
              <table className="w-full text-sm font-sans border-collapse mb-8">
                ...
                <tbody>
                  {(() => {
                    ...
                    const fba = (sensitivityData as Record<string, unknown>)
                      .filter_bias_analysis as
                  ...
                  {['barriers', 'readiness', 'maturity'].map((construct) => (
                    <tr key={construct} className="hover:bg-gray-50">
                      ...
                      {PRIMARY_GROUPS.map((group) => {
                        ...
                        const c = constructs?.[construct] as
          ...
          <section className={SECTION_CLASSES}>
            ...
            <p className={PARAGRAPH_CLASSES}>
              ...
              <strong>large deltas</strong> (highlighted in amber) between Conservative Clean and
              less restrictive groups warrant further investigation, as the finding may depend on
              sample composition.
            </p>
            <p className={PARAGRAPH_CLASSES}>
