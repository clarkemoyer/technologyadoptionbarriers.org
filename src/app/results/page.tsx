        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-10 text-gray-800">
            <p className={PARAGRAPH_CLASSES}>
              The Technology Adoption Barriers Survey (TABS) collects data from organizational
              leaders about the barriers, readiness, and maturity factors that influence technology
              adoption. Every metric is computed independently across four primary result groups so
              researchers can choose the dataset that matches their quality requirements.
            </p>
            <p className={PARAGRAPH_CLASSES}>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className={PARAGRAPH_CLASSES}>
              Each page below covers a different aspect of the survey results. Pages are updated
              daily from live pipeline data.
            </p>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 font-sans text-sm">
              ...
              <p className="text-gray-700 italic">
                Moyer, C. (2026). Technology Adoption Barriers Survey (TABS): Survey results and
                open data.{' '}
