      ...
      <ResultsNav>
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-10 text-gray-800">
            <p className="mb-6">
              The Technology Adoption Barriers Survey (TABS) draws significant inspiration from one
              of the most successful longitudinal research initiatives in business:{' '}
              <em>The CMO Survey</em>. Since 2008, The CMO Survey has provided invaluable insights
              into marketing trends, spending patterns, and strategic priorities, serving as a
              trusted benchmark for marketing leaders worldwide.
            </p>
            <p className="mb-6">
              This page explores how The CMO Survey&apos;s proven methodology, longitudinal
              approach, and commitment to open access have shaped the development and vision of
              TABS.
            </p>
          </section>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className="mb-4">
              ...
              disseminates the opinions of top marketing executives to predict the future of
              markets, track marketing excellence, and improve the value of marketing in firms and
              in society.
            </p>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className="mb-6">
              TABS aims to replicate The CMO Survey&apos;s success in the technology sector,
              bringing the same rigor, longitudinal approach, and open-access philosophy to
              understanding technology adoption barriers. Here&apos;s how The CMO Survey has
              directly influenced our work:
            </p>
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                ...
                decision-makers. TABS follows this model by targeting the full C-suite (CEO, CFO,
                CIO, CISO, COO, CMO, CTO, CSO, CHRO, CRO) who shape their organizations&apos;
                technology strategies. This focus ensures that our data reflects:
              </p>
              <ul className="list-disc list-inside mb-4 space-y-2 text-gray-800">
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                ...
                lending it credibility and ensuring methodological rigor. Similarly, TABS is
                grounded in established academic frameworks:
              </p>
              <ul className="list-disc list-inside mb-4 space-y-2 text-gray-800">
                <li>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                ...
                technology adoption barriers, organizational readiness, and capability maturity.
                This specialized focus allows us to provide deeper insights into:
              </p>
              <ul className="list-disc list-inside mb-4 space-y-2 text-gray-800">
                <li>
            ...
            <div className="mb-8">
              ...
              <p className="mb-4">
                ...
                complexity, shifting vendor landscapes, and compressed evaluation timelines have
                posed challenges within their organizations over the past 12 months.
              </p>
            </div>
          </section>
            ...
            <ul className="space-y-3 text-gray-800">
              <li className="flex items-start">
                ...
                <span>
                  ...
                  demonstrates that longitudinal, open-access research can become an industry
                  standard and trusted benchmark.
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-green-600 font-bold mr-3">✓</span>
                <span>
                  ...
                  strategic perspectives that operational surveys cannot capture, making the data
                  more valuable for decision-makers.
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-green-600 font-bold mr-3">✓</span>
              ...
              <li className="flex items-start">
                <span className="text-green-600 font-bold mr-3">✓</span>
                <span>
                  <strong>Academic Rigor Builds Credibility:</strong> Grounding surveys in
                  established frameworks and peer-reviewed methodologies ensures reliability and
                  trust among academics and practitioners alike.
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-green-600 font-bold mr-3">✓</span>
                <span>
                  <strong>TABS Adapts the Model:</strong> While following The CMO Survey&apos;s
                  proven approach, TABS tailors it for technology adoption research with broader
                  C-suite coverage and agility for rapid tech evolution.
                </span>
              </li>
            </ul>
          </section>
