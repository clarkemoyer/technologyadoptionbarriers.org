    ...
    <div className="space-y-2 my-4">
      {categories.map((cat) => (
        <div key={cat.label} className="flex items-center gap-3 text-sm">
          ...
          {/* Fix: role="img" on the container exposes aria-label to screen readers;
              the inner fill div is decorative (aria-hidden). */}
          <div
              ...
              <div className="space-y-2 my-4">
                {ageRanges.map((r) => (
                  <div key={r.range} className="flex items-center gap-3 text-sm">
                    ...
                    {/* Fix: role="img" on container exposes aria-label to screen readers */}
                    <div
                      className="flex-1 bg-gray-100 rounded h-5 overflow-hidden"
                      role="img"
                      aria-label={
                    ...
                    >
                      {r.count !== null && ageBarMax > 0 ? (
                        ...
                        /* Fix: explicit width: 0% so suppressed bins don't render at full width */
                        <div
