        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <ul className="list-disc pl-6 space-y-2 mb-6">
              ...
              <li>
                <strong>Screen reader support</strong> - content is structured with semantic HTML
              ...
              <li>
                <strong>Focus indicators</strong> - visible focus outlines on all interactive
                elements using{' '}
...
it('has no accessibility violations', async () => {
  ...
  expect(results).toHaveNoViolations()
            ...
            <p className="mb-6">
              ...
              violation - a missing ARIA label, an incorrect role, a form input without a label -
              the test fails and the PR cannot be merged.
            </p>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="p-4 rounded-lg border-l-4 border-orange-400 bg-orange-50">
                ...
                <p className="text-sm text-gray-700">
                  ...
                  <code className="text-xs bg-gray-200 px-1 py-0.5 rounded">&lt;a&gt;</code>{' '}
                  elements. Fix: wrapped in{' '}
                  <code className="text-xs bg-gray-200 px-1 py-0.5 rounded">
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className="mb-6">
              We prioritize semantic HTML over ARIA workarounds. The principle is simple: if there
              is a native HTML element that does what you need, use it instead of adding ARIA
              attributes to a generic element.
            </p>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <ul className="list-disc pl-6 space-y-2 mb-6">
              <li>
                <strong>Tab order</strong> follows visual reading order (left-to-right,
                top-to-bottom)
              </li>
              <li>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <ul className="list-disc pl-6 space-y-2 mb-6">
              <li>
                <strong>PR accessibility checklist</strong> - every pull request template includes
                an accessibility section that reviewers must check
              </li>
              <li>
