        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className={SECTION_CLASSES}>
            <p className={PARAGRAPH_CLASSES}>
              ...
              verified by running our public analysis scripts against the released dataset. This
              page explains how the pipeline works and how you can use it.
            </p>
            <p className={PARAGRAPH_CLASSES}>
              ...
              under a CC-BY-4.0 license, ensuring long-term institutional preservation independent
            ...
            <div className="space-y-8">
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-600 font-sans text-sm">
                  <strong>Waterfall steps:</strong> Incomplete check, Prolific auth verification,
                  IRI attention checks (3 constructs), speed flags, Smeal benchmark, reCAPTCHA
                  score, full-block straightlining, partial straightlining (within-person SD), and
                  final CLEAN disposition.
                </p>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <p className={PARAGRAPH_CLASSES}>
                  ...
                  means, standard deviations, correlations with 95% confidence intervals, t-tests
                  with effect sizes, ANOVA, sensitivity analysis across sample definitions, and
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <p className={PARAGRAPH_CLASSES}>
                  Validates 84 statistical claims embedded in the CRP document against computed
                  values from the source CSV. This ensures that all reported statistics &mdash;
                  construct means, correlations, reliability coefficients, validity metrics, and
                  demographic tables &mdash; are traceable to the data and protects against
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <p className="text-gray-600 font-sans text-sm">
                  <strong>Key outputs:</strong> Response entropy analysis, acquiescence bias
                  metrics, extreme response style detection, position-based fatigue, and
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                ...
                <p className={PARAGRAPH_CLASSES}>
                  Validates 81 statistical claims in the defense presentation (PPTX) against
                  computed values from the source CSV. Ensures consistency between the CRP document
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className={PARAGRAPH_CLASSES}>
              Every key statistic is computed across all sample definitions to verify that
              conclusions do not depend on a single set of inclusion criteria. If a finding holds
              across Conservative Clean, Flexible Clean, and Prolific Accepted samples, it is
              robust. If it shifts substantially, the sensitivity analysis flags it for discussion.
            </p>
            ...
            {(sensitivityData.metrics.length === 0 ||
              sensitivityData.metrics.every(
                (metric) => Object.keys(metric.values).length === 0
              )) && (
...
python tabs_v2_analysis.py <csv> --primary-sample prolific_accepted`}</pre>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className={PARAGRAPH_CLASSES}>
              The repository includes multiple test datasets and a comprehensive pytest suite so
              that anyone can verify the analysis logic without production data.
            </p>
              ...
              <table className="w-full border-collapse font-sans text-sm">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border border-gray-300 px-4 py-2">
                      Simplified format for quick logic checks with 5 actual response rows (clean,
                      IRI fail, duration fail, Don&rsquo;t Know); blank Qualtrics-style metadata
            ...
            <p className={PARAGRAPH_CLASSES}>
              ...
              cross-validation between scripts, edge cases, CLI argument parsing, and the
              operational pipeline tools. Tests run automatically in CI on every push.
            </p>
          </section>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className={PARAGRAPH_CLASSES}>
              The most dangerous failure mode in a dual-system research pipeline is silent
              divergence: the live pipeline and the public scripts gradually drift apart until they
              produce different results from the same data. The TABS project prevents this through
              three mechanisms:
            </p>
            <ol className={BODY_OL_CLASSES}>
              <li>
                <strong>Centralized constants:</strong> All instrument definitions (scale labels,
                IRI answers, column names, thresholds) live in one file. Neither the TypeScript nor
                Python code hardcodes these values independently.
              </li>
              <li>
                <strong>CI validation:</strong> Every commit that touches constants or analysis
                scripts triggers an automated workflow that regenerates the JSON export, validates
                all values match, and runs the Python scripts against test data.
              </li>
              <li>
              ...
              <table className="w-full border-collapse font-sans text-sm">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border border-gray-300 px-4 py-2">
                      &ldquo;Major Barrier&rdquo; = 5, &ldquo;Very Low Readiness/Capability&rdquo; =
                      1
                    </td>
                    <td className="border border-gray-300 px-4 py-2">
                      If one system maps a label to the wrong number, all statistics diverge
                      silently
                    </td>
                  </tr>
                  <tr className="bg-gray-50">
          ...
          <section className="mb-12 text-gray-800">
            ...
            <ul className={BODY_LIST_CLASSES}>
              ...
              <li>
                <strong>Test data included:</strong> Three test datasets (5 + 15 + 500 records) and
                a deterministic generator exercise all processing paths without requiring production
                data access
              </li>
              <li>
              ...
              <li>
                <strong>Versioned datasets:</strong> Each data release (N=200, N=500, annual)
                receives its own DOI via ScholarSphere
              </li>
              <li>
          ...
          <section className="mb-12 text-gray-800">
            ...
            <p className={PARAGRAPH_CLASSES}>
              ...
              repository welcomes pull requests. The analysis scripts are designed to be extended:
              add new statistical tests, improve visualizations, or adapt the pipeline for your own
              research context.
            </p>
