...
const HTMT_DATA: HTMTPair[] = [
  { pair: 'Barriers-Readiness', htmt: 0.4981, ci_95: [0.3963, 0.6527], passes_085: true, passes_090: true },
  { pair: 'Barriers-Maturity', htmt: 0.4407, ci_95: [0.3684, 0.5458], passes_085: true, passes_090: true },
  { pair: 'Readiness-Maturity', htmt: 0.8044, ci_95: [0.7098, 0.8804], passes_085: true, passes_090: true },
]
...
const FL_DATA: FLPair[] = [
  { pair: 'Barriers-Readiness', sqrt_ave_1: 0.5372, sqrt_ave_2: 0.6325, correlation: -0.3814, passes: true },
  { pair: 'Barriers-Maturity', sqrt_ave_1: 0.5372, sqrt_ave_2: 0.7024, correlation: -0.3156, passes: true },
  { pair: 'Readiness-Maturity', sqrt_ave_1: 0.6325, sqrt_ave_2: 0.7024, correlation: 0.7194, passes: false },
]
...
const BARRIERS_4F_CFA = {
  chi2: 307.835, df: 129, chi2_p: 0, cfi: 0.8265, tli: 0.7942, rmsea: 0.0852,
  aic: 80.79, bic: 217.61,
}
...
const ReliabilityCard = ({ c }: { c: ConstructValidation }) => (
  <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
    <div className="bg-tabs-teal-deep text-white px-4 py-2 font-bold font-sans">
      {c.construct} <span className="font-normal opacity-80">({c.n_items} items, N={c.n_valid})</span>
    </div>
    <div className="p-4">
        ...
        <tbody>
          <tr className="border-b">
            <td className="py-1.5 text-gray-600">
              <Link href="/results/crp-2026/glossary#cronbach-alpha" className="hover:text-blue-600 hover:underline">
          ...
          <tr className="border-b">
            <td className="py-1.5 text-gray-600">
              <Link href="/results/crp-2026/glossary#mcdonalds-omega" className="hover:text-blue-600 hover:underline">
          ...
          <tr className="border-b">
            <td className="py-1.5 text-gray-600">
              <Link href="/results/crp-2026/glossary#composite-reliability" className="hover:text-blue-600 hover:underline">
                Composite Reliability
              </Link>
            </td>
            <td className="py-1.5 text-right font-mono font-bold">{fmt(c.composite_reliability, 4)}</td>
            <td className="py-1.5 text-right">
              <Verdict pass={c.composite_reliability >= 0.7} label={c.composite_reliability >= 0.8 ? 'Good' : c.composite_reliability >= 0.7 ? 'Acceptable' : 'Low'} />
            </td>
          </tr>
          <tr className="border-b">
            <td className="py-1.5 text-gray-600">
              <Link href="/results/crp-2026/glossary#ave" className="hover:text-blue-600 hover:underline">
                AVE
              </Link>
            </td>
            <td className="py-1.5 text-right font-mono font-bold">{fmt(c.ave_from_loadings, 4)}</td>
            <td className="py-1.5 text-right">
              <Verdict pass={c.ave_from_loadings >= 0.5} label={c.ave_from_loadings >= 0.5 ? '\u2265 .50' : '< .50 (CR compensates)'} />
            </td>
          </tr>
          <tr>
            <td className="py-1.5 text-gray-600">
              <Link href="/results/crp-2026/glossary#split-half" className="hover:text-blue-600 hover:underline">
...
const EFACard = ({ c }: { c: ConstructValidation }) => (
  <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
    <div className="bg-indigo-700 text-white px-4 py-2 font-bold font-sans">
      {c.construct} EFA
    </div>
    <div className="p-4">
      <table className="w-full text-sm font-sans border-collapse">
        <tbody>
          <tr className="border-b">
            <td className="py-1.5 text-gray-600">
              <Link href="/results/crp-2026/glossary#kmo" className="hover:text-blue-600 hover:underline">KMO</Link>
            </td>
            <td className="py-1.5 text-right font-mono font-bold">{fmt(c.kmo)}</td>
            <td className="py-1.5 text-right">
              <Verdict
                pass={c.kmo >= 0.8}
                label={c.kmo >= 0.9 ? 'Marvelous' : c.kmo >= 0.8 ? 'Meritorious' : c.kmo >= 0.7 ? 'Middling' : 'Low'}
              />
            </td>
          </tr>
          <tr className="border-b">
            <td className="py-1.5 text-gray-600">
              <Link href="/results/crp-2026/glossary#bartlett" className="hover:text-blue-600 hover:underline">
          ...
          <tr className="border-b">
            <td className="py-1.5 text-gray-600">
              <Link href="/results/crp-2026/glossary#parallel-analysis" className="hover:text-blue-600 hover:underline">
          ...
          <tr className="border-b">
            <td className="py-1.5 text-gray-600">
              <Link href="/results/crp-2026/glossary#variance-explained" className="hover:text-blue-600 hover:underline">
                Variance Explained
              </Link>
            </td>
          ...
          <tr>
            <td className="py-1.5 text-gray-600">
              <Link href="/results/crp-2026/glossary#eigenvalue" className="hover:text-blue-600 hover:underline">
                Top Eigenvalues
              </Link>
            </td>
      ...
      <table className="w-full text-sm font-sans border-collapse">
        <tbody>
          ...
          <tr className="border-b">
            ...
            <td className="py-1.5 text-right font-mono">{fmt(c.cfa_chi2, 1)} ({c.cfa_df})</td>
            <td className="py-1.5 text-right text-xs text-gray-400">p {pFmt(c.cfa_p)}</td>
          </tr>
          <tr className="border-b">
            <td className="py-1.5 text-gray-600">
              <Link href="/results/crp-2026/glossary#cfi" className="hover:text-blue-600 hover:underline">CFI</Link>
            </td>
            <td className="py-1.5 text-right font-mono font-bold">{fmt(c.cfa_cfi)}</td>
            <td className="py-1.5 text-right">
              <Verdict pass={c.cfa_cfi >= 0.9} label={c.cfa_cfi >= 0.95 ? 'Good' : c.cfa_cfi >= 0.9 ? 'Acceptable' : 'Poor'} />
            </td>
          </tr>
          <tr className="border-b">
            <td className="py-1.5 text-gray-600">
              <Link href="/results/crp-2026/glossary#tli" className="hover:text-blue-600 hover:underline">TLI</Link>
            </td>
            <td className="py-1.5 text-right font-mono font-bold">{fmt(c.cfa_tli)}</td>
            <td className="py-1.5 text-right">
              <Verdict pass={c.cfa_tli >= 0.9} label={c.cfa_tli >= 0.95 ? 'Good' : c.cfa_tli >= 0.9 ? 'Acceptable' : 'Poor'} />
            </td>
          </tr>
          <tr>
            <td className="py-1.5 text-gray-600">
              <Link href="/results/crp-2026/glossary#rmsea" className="hover:text-blue-600 hover:underline">RMSEA</Link>
            </td>
            <td className="py-1.5 text-right font-mono font-bold">{fmt(c.cfa_rmsea)}</td>
            <td className="py-1.5 text-right">
              <Verdict pass={c.cfa_rmsea <= 0.08} label={c.cfa_rmsea <= 0.06 ? 'Good' : c.cfa_rmsea <= 0.08 ? 'Acceptable' : 'Poor'} />
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <article className={ARTICLE_CLASSES}>
        ...
        <section className={SECTION_CLASSES}>
          <p className={PARAGRAPH_CLASSES}>
            ...
            <code className="text-sm bg-gray-100 px-1.5 py-0.5 rounded font-mono">tabs_v2_validation.py</code>{' '}
            ...
            <table className="w-full text-sm font-sans border-collapse mb-4">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  {CONSTRUCTS.map((c) => (
                    <th key={c.construct} className="text-right px-3 py-2 border">{c.construct}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
        ...
        <section className={SECTION_CLASSES}>
          ...
          <p className="text-sm text-gray-500 font-sans">
            Barriers extract 2 factors (Internal/Organizational + External/Compliance).
            Readiness and Maturity are each unidimensional. See{' '}
            <Link href="/results/crp-2026/factor-analysis" className="text-blue-600 hover:underline">
              Factor Analysis
            </Link>{' '}
        ...
        <section className={SECTION_CLASSES}>
          ...
          <div className="overflow-x-auto mb-4">
            <table className="w-full text-sm font-sans border-collapse">
              ...
              <tbody>
                <tr><td className="px-3 py-1.5 border">&chi;&sup2; (df)</td><td className="text-right px-3 py-1.5 border font-mono">{fmt(BARRIERS_4F_CFA.chi2, 1)} ({BARRIERS_4F_CFA.df})</td><td className="text-right px-3 py-1.5 border text-xs text-gray-400">p {pFmt(BARRIERS_4F_CFA.chi2_p)}</td></tr>
                <tr className="bg-gray-50"><td className="px-3 py-1.5 border">CFI</td><td className="text-right px-3 py-1.5 border font-mono font-bold">{fmt(BARRIERS_4F_CFA.cfi)}</td><td className="text-right px-3 py-1.5 border"><Verdict pass={BARRIERS_4F_CFA.cfi >= 0.9} label={BARRIERS_4F_CFA.cfi >= 0.95 ? 'Good' : BARRIERS_4F_CFA.cfi >= 0.9 ? 'Acceptable' : 'Poor'} /></td></tr>
                <tr><td className="px-3 py-1.5 border">TLI</td><td className="text-right px-3 py-1.5 border font-mono font-bold">{fmt(BARRIERS_4F_CFA.tli)}</td><td className="text-right px-3 py-1.5 border"><Verdict pass={BARRIERS_4F_CFA.tli >= 0.9} label={BARRIERS_4F_CFA.tli >= 0.95 ? 'Good' : BARRIERS_4F_CFA.tli >= 0.9 ? 'Acceptable' : 'Poor'} /></td></tr>
                <tr className="bg-gray-50"><td className="px-3 py-1.5 border">RMSEA</td><td className="text-right px-3 py-1.5 border font-mono font-bold">{fmt(BARRIERS_4F_CFA.rmsea)}</td><td className="text-right px-3 py-1.5 border"><Verdict pass={BARRIERS_4F_CFA.rmsea <= 0.08} label={BARRIERS_4F_CFA.rmsea <= 0.06 ? 'Good' : BARRIERS_4F_CFA.rmsea <= 0.08 ? 'Acceptable' : 'Poor'} /></td></tr>
                <tr><td className="px-3 py-1.5 border">AIC</td><td className="text-right px-3 py-1.5 border font-mono">{fmt(BARRIERS_4F_CFA.aic, 1)}</td><td className="text-right px-3 py-1.5 border text-xs text-gray-400">Lower is better</td></tr>
                <tr className="bg-gray-50"><td className="px-3 py-1.5 border">BIC</td><td className="text-right px-3 py-1.5 border font-mono">{fmt(BARRIERS_4F_CFA.bic, 1)}</td><td className="text-right px-3 py-1.5 border text-xs text-gray-400">Lower is better</td></tr>
              </tbody>
            </table>
          </div>
          <p className="text-sm text-gray-500 font-sans">
            The 4-factor model (CFI = {fmt(BARRIERS_4F_CFA.cfi)}) improves over the single-factor model (CFI = {fmt(CONSTRUCTS[0].cfa_cfi)})
            but remains below the .90 threshold, consistent with the EFA finding that 2 factors (not 4) best represent the data.
            Full CFA with cross-validation is planned at N=500.
          </p>
        </section>
        ...
        <section className={SECTION_CLASSES}>
          ...
          <p className={PARAGRAPH_CLASSES}>
            Discriminant validity assesses whether the three TABS constructs are empirically distinct
            from one another. Two complementary methods are used: HTMT and the Fornell-Larcker
            criterion.
          </p>
              ...
              <tbody>
                {HTMT_DATA.map((h, i) => (
                  <tr key={h.pair} className={i % 2 === 1 ? 'bg-gray-50' : ''}>
                    ...
                    <td className="text-right px-3 py-1.5 border font-mono font-bold">{fmt(h.htmt)}</td>
                    <td className="text-right px-3 py-1.5 border font-mono text-xs">
                      [{fmt(h.ci_95[0])}, {fmt(h.ci_95[1])}]
                    </td>
                    <td className="text-center px-3 py-1.5 border"><Verdict pass={h.passes_085} /></td>
                    <td className="text-center px-3 py-1.5 border"><Verdict pass={h.passes_090} /></td>
                  </tr>
                ))}
              </tbody>
            </table>
            ...
            <table className="w-full text-sm font-sans border-collapse">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="text-right px-3 py-2 border">&radic;AVE<sub>1</sub></th>
                  <th className="text-right px-3 py-2 border">&radic;AVE<sub>2</sub></th>
              ...
              <tbody>
                {FL_DATA.map((fl, i) => (
                  <tr key={fl.pair} className={i % 2 === 1 ? 'bg-gray-50' : ''}>
                    ...
                    <td className="text-right px-3 py-1.5 border font-mono">{fmt(fl.sqrt_ave_1)}</td>
                    <td className="text-right px-3 py-1.5 border font-mono">{fmt(fl.sqrt_ave_2)}</td>
                    <td className="text-right px-3 py-1.5 border font-mono font-bold">{fmt(Math.abs(fl.correlation))}</td>
                    <td className="text-center px-3 py-1.5 border"><Verdict pass={fl.passes} /></td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 font-sans text-sm">
            ...
            <p className="text-amber-700">
              The Fornell-Larcker criterion fails for the Readiness-Maturity pair, while HTMT (.804) passes
              the .85 threshold. This reflects their shared &ldquo;organizational capability&rdquo;
              dimension: Readiness originates from the TRI/adoption literature and Maturity from
              CMMI/IT governance. Both scales provide distinct value to their respective practitioner
              communities despite measuring overlapping variance. A bifactor CFA confirms they are
              empirically distinguishable (HTMT &lt; .85, CR &gt; .80 for both).
            </p>
          </div>
        </section>
                ...
                {['Barriers', 'Readiness', 'Maturity'].map((row, ri) => (
                  <tr key={row} className={ri % 2 === 1 ? 'bg-gray-50' : ''}>
                    ...
                    {['Barriers', 'Readiness', 'Maturity'].map((col) => {
                      ...
                      return (
                        <td key={col} className={`text-right px-3 py-1.5 border font-mono ${isDiag ? 'bg-gray-200 font-bold' : ''}`}>
        ...
        <section className={SECTION_CLASSES}>
          ...
          <p className={PARAGRAPH_CLASSES}>
            ...
            deleting them would increase Cronbach&rsquo;s alpha. Only one item is flagged across
            all 43 items:
          </p>
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 font-sans text-sm mb-6">
            ...
            <p className="text-red-700 mt-1">
              ...
              with organizational/strategic barriers. Retained for substantive coverage: cybersecurity
              is a critical barrier domain for IT leaders. Removing it would increase Barriers &alpha;
              from .873 to .880 (negligible gain).
            </p>
          </div>
              ...
              <tbody>
                {CONSTRUCTS.map((c, i) => (
                  <tr key={c.construct} className={i % 2 === 1 ? 'bg-gray-50' : ''}>
                    ...
                    <td className="text-right px-3 py-1.5 border font-mono">{fmt(c.inter_item_mean)}</td>
                    <td className="text-right px-3 py-1.5 border font-mono">{fmt(c.inter_item_min, 2)}</td>
                    <td className="text-right px-3 py-1.5 border font-mono">{fmt(c.inter_item_max, 2)}</td>
                    <td className="text-right px-3 py-1.5 border font-mono">{fmt(c.inter_item_sd, 2)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <p className="text-sm text-gray-500 font-sans">
            Optimal mean inter-item correlation: 0.15 to 0.50 (Clark &amp; Watson, 1995). All
            three constructs fall within this range.
          </p>
        </section>
        ...
        <section className={SECTION_CLASSES}>
          ...
          <p className={PARAGRAPH_CLASSES}>
            The TABS instrument demonstrates strong reliability (all &alpha; &gt; .85, all CR &gt; .87)
            and adequate factor structure at N=200. Readiness and Maturity show excellent CFA fit
            as unidimensional scales. Barriers is inherently multi-dimensional (2-factor EFA), so
            single-factor CFA fit is expected to be poor. All HTMT ratios pass the conservative .85
            threshold. The one item-level flag (B13 Cybersecurity) is retained for substantive
