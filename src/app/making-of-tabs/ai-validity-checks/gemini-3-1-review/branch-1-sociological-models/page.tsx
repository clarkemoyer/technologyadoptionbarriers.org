        ...
        <article className={ARTICLE_CLASSES}>
          ...
          <section className="mb-10 text-gray-800">
            <p className="mb-6">
              ...
              technology spreads through populations and how social environments influence
              individual behavior.
            </p>
            ...
            <p className="mb-4">
              The review verified the attribution of DOI to Everett Rogers (1962). The site
              accurately describes the five adopter categories (Innovators, Early Adopters, Early
              Majority, Late Majority, Laggards) and the five attributes of innovations (Relative
              Advantage, Compatibility, Complexity, Trialability, Observability). The historical
              context of its origins in agricultural sociology is correctly stated.
            </p>
