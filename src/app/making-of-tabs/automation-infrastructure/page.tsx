    ...
    <main className="pt-20 sm:pt-[120px] min-h-screen bg-white">
      <article className={ARTICLE_CLASSES}>
              ...
              <tbody>
                {[
                  ...
                  [
                    '4',
                    'GitHub Actions (CI)',
                    'Runs format check, lint, Jest, build, and Playwright E2E',
                    'Pass / fail status',
                  ],
                  [
                    '5',
        ...
        <section className="mb-12 text-gray-800">
          ...
          <p className="mb-4">
            After Phase 2 completes, Phases 3a and 3b can proceed in parallel, while Phase 3c starts
            only after its required upstream jobs finish, including the approval step. The
            disposition CSV produced in Phase 1 is passed between phases as a GitHub Actions
            artifact with a one-day retention window — it never touches the repository.
          </p>
        </section>
        ...
        <section className="mb-12 text-gray-800">
          ...
          <p className="mb-4">
            ...
            joined in-memory during the enrichment step and is never written to disk or committed to
            the repository. The public dataset excludes all direct identifiers.
          </p>

          <div className="rounded-xl border border-amber-200 bg-amber-50 p-5 mb-4">
            <h3 className={H3_CLASSES}>Privacy Rule</h3>
